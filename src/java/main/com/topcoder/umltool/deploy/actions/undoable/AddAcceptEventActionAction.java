...
/**
 * <p>
 * This action is used to add an AcceptEventAction to the diagram view. It will create model element and graph element,
 * then add them to uml model manager and diagram first. This action is an UndoableAction.
 * </p>
 * @author ly, FireIce, ylouis
 * @version 1.0
 */
public class AddAcceptEventActionAction extends AddNodeAction {
     ...
     * </p>
     */
    private static final String PRESENTATION_NAME = "Add AcceptEventAction";
    ...
    /**
     * <p>
     * Creates an instance of <code>AddAcceptEventActionAction</code>.
     * </p>
     * @param mainFrame
     *            main frame window
     * @param view
     ...
     */
    public AddAcceptEventActionAction(MainFrame mainFrame, DiagramView view, Point position, Dimension size, String name) {
     ...
     */
    public AddAcceptEventActionAction(MainFrame mainFrame, DiagramView view, Point position, Dimension size,
        SimpleState element) {
        super(PRESENTATION_NAME, mainFrame, view);
        this.position = position;
        this.size = size;
    ...
    protected void createModelElement() {
        if (element == null) {
            ...
            element.addTaggedValue(DeployHelper.createTagValue("AcceptEventAction", "True"));
            element.setName(name);
            Uml1SemanticModelBridge bridge = (Uml1SemanticModelBridge) getDiagramView().getDiagram().getOwner();
            setAddModelElementAction(new com.topcoder.uml.actions.model.activity.AddAcceptEventActionAction(element,
    ...
    /**
     * <p>
     * Creates a new AcceptEventAction node.
     * </p>
     */
    protected void createNode() {
        AcceptEventAction node = DeployHelper.createAcceptEventActionNode(getMainFrame(), graphNode);
        setNode(node);
    }
}

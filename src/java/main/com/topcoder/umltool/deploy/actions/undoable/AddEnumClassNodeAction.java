 ...
 * @version 1.0
 */
public class AddEnumClassNodeAction extends AddNodeAction {
     ...
     * </p>
     */
    private static final String PRESENTATION_NAME = "Add Enum Class Node";
     ...
     */
    public AddEnumClassNodeAction(MainFrame mainFrame, DiagramView view, Point position, Dimension size, String name) {

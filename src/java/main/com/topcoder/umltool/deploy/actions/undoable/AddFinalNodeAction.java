...
/**
 * <p>
 * This action is used to add a FinalNode to the diagram view. It will create model element and graph element, then add
 * them to uml model manager and diagram first. This action is an UndoableAction.
 * </p>
 * @author ly, FireIce, ylouis
 * @version 1.0
 */
public class AddFinalNodeAction extends AddNodeAction {
     ...
     * </p>
     */
    private static final String PRESENTATION_NAME = "Add FinalNode";
    ...
    /**
     * <p>
     * Creates an instance of <code>AddFinalNodeAction</code>.
     * </p>
     * @param mainFrame
     *            main frame window
     * @param view
     ...
     */
    public AddFinalNodeAction(MainFrame mainFrame, DiagramView view, Point position, Dimension size, String name) {
     ...
     */
    public AddFinalNodeAction(MainFrame mainFrame, DiagramView view, Point position, Dimension size, FinalState element) {
        super(PRESENTATION_NAME, mainFrame, view);
        this.position = position;
        this.size = size;
    ...
    protected void createModelElement() {
        if (element == null) {
            ...
            setAddModelElementAction(new com.topcoder.uml.actions.model.activity.AddFinalNodeAction(element,
    ...
    /**
     * <p>
     * Creates a new FinalNode.
     * </p>
     */
    protected void createNode() {
        FinalNode node = DeployHelper.createFinalNode(getMainFrame(), graphNode);
        setNode(node);
    }

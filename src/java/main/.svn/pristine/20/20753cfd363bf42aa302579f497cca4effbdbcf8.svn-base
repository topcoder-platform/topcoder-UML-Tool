...
/**
 * <p>
 * Implementation of the ActionEventListener interface. This class is registered to listen to the property change of
 ...
 * @version 1.0
 */
public class ChangePropertyHandler implements ActionEventListener {
    /**
     * <p>
    ...
    /**
     * <p>
     * Creates an instance of ChangePropertyHandler with the mainframe.
     * </p>
     * @param mainFrame
     *            the mainFrame
     */
    public ChangePropertyHandler(MainFrame mainFrame) {
    ...
    private void updatePropety(EventObject event) {
        ...
        for (JComponent jComponent : jComponents) {
            if (jComponent instanceof Node) {
                ...
                DeployHelper.nodeNotifyChange(node, "Property changed", mainFrame);

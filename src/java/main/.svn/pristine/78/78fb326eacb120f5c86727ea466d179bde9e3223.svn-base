...
public class UMLToolMacLookAndFeel extends AquaLookAndFeel {
	...
	protected void initComponentDefaults(UIDefaults table) {
		...
		try {
			UIManager.put("SectionHeaderUI",
					"com.topcoder.umltool.deploy.GradSectionHeaderUI");

			UIManager.put("MainFrame.backgroundColor", new Color(110,110,110));
			UIManager.put("UMLTabbedPanelUI",
					new UMLToolTabbedPanelUI());
			UIManager.put("SectionBorderColor", new Color(62,62,62));
			UIManager.put(DefaultSectionHeaderUI.class,
					GradSectionHeaderUI.class.getDeclaredMethod("createUI",
							JComponent.class));
			UIManager.put("SectionHeader.font",
					new Font("Arial", Font.BOLD, 12));
			UIManager.put("SectionHeader.height", new Integer(20));
			UIManager.put("SectionHeader.expandedHeaderForeGroundColor",
					Color.white);
			UIManager.put("SectionHeader.contractedHeaderForeGroundColor",
					Color.black);
			...
			UIManager.put("SectionHeader.expandedIcon", new ImageIcon(
					getClass().getResource(EXPAND_ICON_FILE_NAME)));
			UIManager.put("SectionHeader.contractedIcon", new ImageIcon(
					getClass().getResource(CONTRACT_ICON_FILE_NAME)));
			...
			UIManager.put("SectionHeader.expandedBgLeftIcon", new ImageIcon(
					getClass().getResource(EXPAND_LEFT_FILE_NAME)));
			UIManager.put("SectionHeader.expandedBgRightIcon", new ImageIcon(
					getClass().getResource(EXPAND_RIGHT_FILE_NAME)));
			UIManager.put("SectionHeader.expandedBgMidIcon", new ImageIcon(
					getClass().getResource(EXPAND_FILL_FILE_NAME)));
			UIManager.put("SectionHeader.contractedBgLeftIcon", new ImageIcon(
					getClass().getResource(CONTRACT_LEFT_FILE_NAME)));
			...
			UIManager.put("ButtomPanel.minIcon", new ImageIcon(getClass()
					.getResource(BOTTOM_MIN_ICON_FILE_NAME)));
			UIManager.put("ButtomPanel.fullIcon", new ImageIcon(getClass()
					.getResource(BOTTOM_FULL_ICON_FILE_NAME)));
			UIManager.put("ButtomPanel.restoreIcon", new ImageIcon(getClass()
					.getResource(BOTTOM_RESTORE_ICON_FILE_NAME)));

			UIManager.put("SideMenu.expandIcon", new ImageIcon(getClass()
					.getResource(SIDEMENU_EXPAND_ICON_FILE_NAME)));
			UIManager.put("SideMenu.collapseIcon", new ImageIcon(getClass()
					.getResource(SIDEMENU_COLLAPSE_ICON_FILE_NAME)));
			UIManager.put("SideMenu.pinIcon", new ImageIcon(getClass()
					.getResource(SIDEMENU_PIN_ICON_FILE_NAME)));
			...
			UIManager.put("TabbedPane.selectedFont",
				new Font("Arial", Font.BOLD, 12));

			UIManager.put("TabbedPane.selectedFontColor",
				new Color(59,59,59));

			UIManager.put("TabbedPane.unselectedFont",
				new Font("Arial", Font.PLAIN, 12));

			UIManager.put("TabbedPane.unselectedFontColor",

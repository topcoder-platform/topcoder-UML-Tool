...
/**
 * <p>
 * This is an action to be used to move specified component to back.
 * </p>
 * @author ly
 * @version 1.0
 */
public class MoveToBackAction extends AbstractAction {
    ...
    /**
     * <p>
     * Represents the component which will be moved to back by this action.
     * </p>
     */
    ...
    /**
     * <p>
     * Defines an <code>MoveToBackAction</code> object with the specified description string for specified component.
     * </p>
     * @param name
     ...
     *            main frame window
     */
    public MoveToBackAction(String name, JComponent component, MainFrame mainFrame) {
        super(name);
    ...
    /**
     * <p>
     * Moves specified component to back.
     * </p>
     * @param e
    ...
    public void actionPerformed(ActionEvent e) {
        if (component instanceof Node) {
            ...
            ChangeZOrderAction changeZOrderAction = new ChangeZOrderAction(diagramElement,
                    ChangeZOrderOperationType.TOBACK);

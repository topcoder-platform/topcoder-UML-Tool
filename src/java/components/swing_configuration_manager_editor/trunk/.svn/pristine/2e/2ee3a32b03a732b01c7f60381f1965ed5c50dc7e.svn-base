...
import com.topcoder.gui.configurationmanager.ValidationException;
import com.topcoder.util.errorhandling.ExceptionData;

/**
 * <p>
 * This class contains a set of tests for {@link ValidationException} class.
 * </p>
 *
 * @author uhmateush
 * @version 1.0
...
public class ValidationExceptionTests extends TestCase {
    ...
    public void testConstructor0() {
        ValidationException e = new ValidationException(TEST_MESSAGE);
    ...
    public void testConstructor1() {
        ValidationException e
            = new ValidationException(TEST_MESSAGE, cause);
    ...
    public void testConstructor2() {
        ValidationException e
            = new ValidationException(TEST_MESSAGE, data);
        assertEquals("The message is incorrect.", TEST_MESSAGE, e.getMessage());
    ...
    public void testConstructor3() {
        ValidationException e
            = new ValidationException(TEST_MESSAGE, cause, data);
        assertEquals("The message is incorrect.", TEST_MESSAGE, e.getMessage());

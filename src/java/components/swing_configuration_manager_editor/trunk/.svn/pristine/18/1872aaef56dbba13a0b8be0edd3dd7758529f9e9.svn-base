...
import com.topcoder.gui.configurationmanager.SavingException;
import com.topcoder.util.errorhandling.ExceptionData;

/**
 * <p>
 * This class contains a set of tests for {@link SavingException} class.
 * </p>
 *
 * @author uhmateush
 * @version 1.0
...
public class SavingExceptionTests extends TestCase {
    ...
    public void testConstructor0() {
        SavingException e = new SavingException(TEST_MESSAGE);
    ...
    public void testConstructor1() {
        SavingException e
            = new SavingException(TEST_MESSAGE, cause);
    ...
    public void testConstructor2() {
        SavingException e
            = new SavingException(TEST_MESSAGE, data);
        assertEquals("The message is incorrect.", TEST_MESSAGE, e.getMessage());
    ...
    public void testConstructor3() {
        SavingException e
            = new SavingException(TEST_MESSAGE, cause, data);
        assertEquals("The message is incorrect.", TEST_MESSAGE, e.getMessage());

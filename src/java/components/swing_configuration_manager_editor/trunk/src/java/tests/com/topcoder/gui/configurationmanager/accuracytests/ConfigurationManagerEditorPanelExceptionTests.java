...
import com.topcoder.gui.configurationmanager.ConfigurationManagerEditorPanelException;
import com.topcoder.util.errorhandling.ExceptionData;

/**
 * <p>
 * This class contains a set of tests for {@link ConfigurationManagerEditorPanelException} class.
 * </p>
 *
 * @author uhmateush
 * @version 1.0
...
public class ConfigurationManagerEditorPanelExceptionTests extends TestCase {
    ...
    public void testConstructor0() {
        ConfigurationManagerEditorPanelException e = new ConfigurationManagerEditorPanelException(TEST_MESSAGE);
    ...
    public void testConstructor1() {
        ConfigurationManagerEditorPanelException e
            = new ConfigurationManagerEditorPanelException(TEST_MESSAGE, cause);
    ...
    public void testConstructor2() {
        ConfigurationManagerEditorPanelException e
        = new ConfigurationManagerEditorPanelException(TEST_MESSAGE, data);
        assertEquals("The message is incorrect.", TEST_MESSAGE, e.getMessage());
    ...
    public void testConstructor3() {
        ConfigurationManagerEditorPanelException e
            = new ConfigurationManagerEditorPanelException(TEST_MESSAGE, cause, data);
        assertEquals("The message is incorrect.", TEST_MESSAGE, e.getMessage());

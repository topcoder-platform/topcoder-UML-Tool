...
/**
 * <p>
 * This class contains a set of tests for {@link ConfigurationException} class.
 * </p>
 *
 * @author uhmateush
 * @version 1.0
...
public class ConfigurationExceptionTests extends TestCase {
    ...
    public void testConstructor0() {
        ConfigurationException e = new ConfigurationException(TEST_MESSAGE);
    ...
    public void testConstructor1() {
        ConfigurationException e
            = new ConfigurationException(TEST_MESSAGE, cause);
    ...
    public void testConstructor2() {
        ConfigurationException e
            = new ConfigurationException(TEST_MESSAGE, data);
        assertEquals("The message is incorrect.", TEST_MESSAGE, e.getMessage());
    ...
    public void testConstructor3() {
        ConfigurationException e
            = new ConfigurationException(TEST_MESSAGE, cause, data);
        assertEquals("The message is incorrect.", TEST_MESSAGE, e.getMessage());

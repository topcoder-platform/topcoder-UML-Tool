...
/**
 * Accuracy tests for the class: MergeNode.
 * 
 * @author kinfkong
 * @version 1.0
 */
public class MergeNodeAccuracyTest extends AccuracyBase {
    ...
    /**
     * Tests the constructor: MergeNode.
     * 
     */
    ...
    /**
     * The UI test for the class: MergeNode.
     */

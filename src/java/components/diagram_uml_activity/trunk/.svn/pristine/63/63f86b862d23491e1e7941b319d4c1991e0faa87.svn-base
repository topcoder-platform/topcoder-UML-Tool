...
/**
 * Accuracy tests for the class: DecisionNode.
 * 
 * @author kinfkong
 * @version 1.0
 */
public class DecisionNodeAccuracyTest extends AccuracyBase {
    ...
    /**
     * Tests the constructor: DecisionNode.
     * 
     */
    ...
    /**
     * The UI test for the class: DecisionNode.
     */
    public static void main(String[] args) {
        ...
        BaseNode node = new DecisionNode(
            graphNode, 
            createProperties(), 
            new Point(5, 5), 
            new Rectangle(5, 5, 75, 75));

 ...
 * attached (TagDefinition(&quot;AcceptEventAction&quot;).value=&quot;True&quot;) from the UML Model and from the
 ...
 * @version 1.0
 */
public class AcceptEventAction extends BaseNode {
    ...
    /**
     * <p>
     * Represents the shape of this node. It is a concave polygon with five vertices. Initialized and changed in
    ...
    /**
     * <p>
     * Creates an <code>AcceptEventAction</code> instance.
     * </p>
     * @param graphNode
     ...
     */
    public AcceptEventAction(GraphNode graphNode, Map<String, String> properties, Point position, Rectangle bound) {
        ...
        notifyGraphNodeChange("AcceptEventAction instance created.");
    }
...
//        graphics.drawPolygon(shape);
     ...
     * @throws IllegalGraphElementException
     *             if the structure of the <code>GraphNode</code> is invalid
     */
    public void notifyGraphNodeChange(String message) {
        ...
        xpoints[0] = xpoints[2] = position.x;
        ypoints[0] = ypoints[4] = position.y;
        xpoints[1] = position.x + PEAK;
        ypoints[1] = position.y + (int) Math.round(d.height * 0.5);
        ypoints[2] = ypoints[3] = position.y + d.height;
        xpoints[3] = xpoints[4] = position.x + d.width;

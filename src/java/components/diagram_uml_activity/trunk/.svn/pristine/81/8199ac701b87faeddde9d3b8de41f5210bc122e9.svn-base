 ...
 * Pseudostate.JOIN from the UML Model and from the <code>GraphNode</code> associated with it, it extends the
...
public class JoinNode extends BaseNode {
    ...
    /**
     * <p>
     * Creates a <code>JoinNode</code> instance.
     * </p>
     * @param graphNode
     ...
     */
    public JoinNode(GraphNode graphNode, Map<String, String> properties, Point position, Rectangle bound) {
        ...
        notifyGraphNodeChange("JoinNode instance created.");
    }

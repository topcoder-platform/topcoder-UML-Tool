...
/**
 * <p>
 * Test the functionality of <code>DecisionNode</code> class.
 * </p>
 * @author TCSDEVELOPER
 * @version 1.0
 */
public class DecisionNodeTest extends JFCTestCase {

    /** An instance of <code>DecisionNode</code> for testing. */
    private DecisionNode decisionNode;

    /** A GraphNode for <code>DecisionNode</code>. */
    ...
    /** Selection bound of <code>DecisionNode</code>. */
    private Rectangle bound = new Rectangle();

    /** Boundary changed listener for <code>DecisionNode</code>. */
    ...
    protected void setUp() throws Exception {
        ...
        decisionNode = new DecisionNode(graphNode, properties, position, bound);

        listener = new MockedBoundaryChangedListener();
    }

    /**
     * Test method for 'DecisionNode(GraphNode, Map, Point, Rectangle)'. The instance should be created successfully.
     */
    public void testDecisionNode_Accuracy() {
        assertNotNull("Test method for 'DecisionNode(GraphNode, Map<String, String>, Point, Rectangle)' failed.",
                decisionNode);
    }

    /**
     * Test method for 'DecisionNode(GraphNode, Map, Point, Rectangle)'. The first argument is null,
     * IllegalArgumentException should be thrown.
     */
    public void testDecisionNode_null_1() {
        try {
            new DecisionNode(null, properties, position, bound);
    ...
    /**
     * Test method for 'DecisionNode(GraphNode, Map, Point, Rectangle)'. The second argument is null,
     * IllegalArgumentException should be thrown.
     */
    public void testDecisionNode_null_2() {
        try {
            new DecisionNode(graphNode, null, position, bound);
            fail("IllegalArgumentException should be thrown.");
        } catch (IllegalArgumentException iae) {
            // Success
        } catch (IllegalGraphElementException e) {
    ...
    /**
     * Test method for 'DecisionNode(GraphNode, Map, Point, Rectangle)'. The third argument is null,
     * IllegalArgumentException should be thrown.
     */
    public void testDecisionNode_null_3() {
        try {
            new DecisionNode(graphNode, properties, null, bound);
            fail("IllegalArgumentException should be thrown.");
        } catch (IllegalArgumentException iae) {
            // Success
        } catch (IllegalGraphElementException e) {
    ...
    /**
     * Test method for 'DecisionNode(GraphNode, Map, Point, Rectangle)'. The fourth argument is null,
     * IllegalArgumentException should be thrown.
     */
    public void testDecisionNode_null_4() {
        try {
            new DecisionNode(graphNode, properties, position, null);
            fail("IllegalArgumentException should be thrown.");
        } catch (IllegalArgumentException iae) {
            // Success
        } catch (IllegalGraphElementException e) {
    ...
    /**
     * Test method for 'DecisionNode(GraphNode, Map, Point, Rectangle)'. The properties map is empty,
     * IllegalArgumentException should be thrown.
     */
    public void testDecisionNode_contain_null() {
        try {
            Map<String, String> map = properties;
            map.put("sfd", null);
            new DecisionNode(graphNode, map, position, bound);
            fail("IllegalArgumentException should be thrown.");
        } catch (IllegalArgumentException iae) {
            // Success
        } catch (IllegalGraphElementException e) {
    ...
    /**
     * Test method for 'DecisionNode(GraphNode, Map, Point, Rectangle)'. Bad GraphNode structure is given,
     * IllegalArgumentException should be thrown.
     */
    public void testDecisionNode_Invalid_GraphNode() {
        try {
    ...
    public void testNotifyGraphNodeChange() {
        ...
        graphNode.setSize(d);
        Rectangle oldBound = decisionNode.getSelectionBound();
        decisionNode.addBoundaryChangedListener(listener);
        decisionNode.notifyGraphNodeChange("GraphNode's width increased.");
        Rectangle newBound = decisionNode.getSelectionBound();
    ...
    public void testGetPreferredGraphNodeSize() {
        assertEquals("The default graph node size should be got correctly.", decisionNode.getPreferredGraphNodeSize(),
                TestUtil.getPrivateField(DecisionNode.class, decisionNode, "DEFAULT_SIZE"));
    }
    ...
    public void testGUI() throws Exception {
        ...
        decisionNode.getNameCompartment().addTextChangedListener(textListener);
        ...
        view.add(decisionNode);

        view.addMouseListener(decisionNode);


        viewer.addMouseListener(decisionNode);

        JDialog dialog = new JDialog((JFrame) null, "DecisionNode", true);
        dialog.setSize(500, 500);
        dialog.getContentPane().add(viewer);
        dialog.setModal(false);
        dialog.setVisible(true);
        NamedComponentFinder finder = new NamedComponentFinder(JComponent.class, "DecisionNode");
        DecisionNode node = (DecisionNode) finder.find(dialog, 0);
        assertNotNull("DecisionNode component should be displayed", node);

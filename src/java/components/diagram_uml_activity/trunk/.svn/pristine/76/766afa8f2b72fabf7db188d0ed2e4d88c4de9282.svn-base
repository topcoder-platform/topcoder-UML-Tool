...
/**
 * Accuracy tests for the class: FlowFinalNode.
 * 
 * @author kinfkong
 * @version 1.0
 */
public class FlowFinalNodeAccuracyTest extends AccuracyBase {
    ...
    /**
     * Tests the constructor: FlowFinalNode.
     * 
     */
    ...
    /**
     * The UI test for the class: FlowFinalNode.
     */
    public static void main(String[] args) {
        ...
        BaseNode node = new FlowFinalNode(
            graphNode, 
            createProperties(), 
            new Point(5, 5), 
            new Rectangle(5, 5, 75, 75));

...
/**
 * Accuracy tests for the class: SendSignalAction.
 * 
 * @author kinfkong
 * @version 1.0
 */
public class SendSignalActionAccuracyTest extends AccuracyBase {
    ...
    /**
     * Tests the constructor: SendSignalAction.
     * 
     */
    ...
    /**
     * The UI test for the class: SendSignalAction.
     */
    public static void main(String[] args) {
        ...
        BaseNode node = new SendSignalAction(
            graphNode, 
            createProperties(), 
            new Point(5, 5), 
            new Rectangle(5, 5, 75, 75));

...
/**
 * Accuracy tests for the class: AcceptEventAction.
 *
 * @author kinfkong
 * @version 1.0
 */
public class AcceptEventActionAccuracyTest extends AccuracyBase {
    ...
    /**
     * Tests the constructor: AcceptEventAction.
     *
     */
    ...
    public void testContains_True() {
        ...
        assertTrue("This point should be within the shape.", node
                        .contains(relative.x + 20, relative.y + 10));
    }
    ...
    /**
     * The UI test for the class: AcceptEventAction.
     */
    public static void main(String[] args) {
        ...
        BaseNode node = new AcceptEventAction(
            graphNode,
            createProperties(),
            new Point(5, 5),
            new Rectangle(5, 5, 75, 75));

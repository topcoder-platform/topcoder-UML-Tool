 ...
 * Pseudostate.JUNCTION from the UML Model and from the <code>GraphNode</code> associated with it, it extends the
...
public class MergeNode extends BaseNode {
    ...
    /**
     * <p>
     * Creates a <code>MergeNode</code> instance.
     * </p>
     * @param graphNode
     ...
     */
    public MergeNode(GraphNode graphNode, Map<String, String> properties, Point position, Rectangle bound) {
        ...
        notifyGraphNodeChange("MergeNode instance created.");
    }

 ...
 * to PseudostateKind.CHOICE retrieved from the clipboard into the
 ...
 * @version 1.0
 */
public class PasteDecisionNodeAction extends PasteStateNodeAbstractAction {
    /**
     * <p>
     * The presentation name for this action.
     * </p>
     */
    private static final String PRESENTATION_NAME = "Paste Decision Node";

    /**
     * <p>
     * Construct a PasteDecisionNodeAction with the content and activityGraph specified.
     * </p>
     *
     ...
     */
    public PasteDecisionNodeAction(Object content, ActivityGraph activityGraph) {
        super(PRESENTATION_NAME, content, activityGraph);

        Util.checkClassType(content, Pseudostate.class);
        Util.checkPseudostateKind((Pseudostate) content, PseudostateKind.CHOICE);
    }
}

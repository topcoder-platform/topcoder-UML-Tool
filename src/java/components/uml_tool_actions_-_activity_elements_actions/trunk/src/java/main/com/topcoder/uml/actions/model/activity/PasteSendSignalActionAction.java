 ...
 * (TagDefinition("SendSignalAction").value="True"), retrieved from the
 ...
 * @version 1.0
 */
public class PasteSendSignalActionAction extends PasteStateNodeAbstractAction {
    /**
     * <p>
     * The presentation name for this action.
     * </p>
     */
    private static final String PRESENTATION_NAME = "Paste Send Signal Action";

    /**
     * <p>
     * Construct a PasteSendSignalActionAction with the content and activityGraph specified.
     * </p>
     *
     ...
     * like TagDefinition(TagDefinition("SendSignalAction").value="True")
     */
    public PasteSendSignalActionAction(Object content, ActivityGraph activityGraph) {
        super(PRESENTATION_NAME, content, activityGraph);

        Util.checkClassType(content, SimpleState.class);

        if (!Util.checkTagDefinition((SimpleState) content, "SendSignalAction", "True")) {

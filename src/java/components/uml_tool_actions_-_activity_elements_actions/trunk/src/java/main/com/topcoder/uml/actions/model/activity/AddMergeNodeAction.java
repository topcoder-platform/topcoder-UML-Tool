...
/**
 * <p>
 * AddMergeNodeAction class extends AddStateNodeAbstractAction abstract class,
 * and this action is specifically used to add Pseudostate node whose kind
 * attribute equals to PseudostateKind.JUNCTION in activity graph.
 * </p>
 *
 * <p>
 ...
 * @version 1.0
 */
public class AddMergeNodeAction extends AddStateNodeAbstractAction {
    /**
     * <p>
     * The presentation name for this action.
     * </p>
     */
    private static final String PRESENTATION_NAME = "Add Merge Node";

    /**
     * <p>
     * Construct an AddMergeNodeAction with the Pseudostate,
     ...
     */
    public AddMergeNodeAction(Pseudostate state, ActivityGraph activityGraph, UMLModelManager manager) {

 ...
 * to PseudostateKind.INITIAL retrieved from the clipboard into
 * the specified activity graph.
 * </p>
 *
 * <p>
 ...
 * @version 1.0
 */
public class PasteInitialNodeAction extends PasteStateNodeAbstractAction {
    /**
     * <p>
     * The presentation name for this action.
     * </p>
     */
    private static final String PRESENTATION_NAME = "Paste Initial Node";

    /**
     * <p>
     * Construct a PasteInitialNodeAction with the content and activityGraph specified.
     *  </p>
     *
     ...
     */
    public PasteInitialNodeAction(Object content, ActivityGraph activityGraph) {
        super(PRESENTATION_NAME, content, activityGraph);

        Util.checkClassType(content, Pseudostate.class);
        Util.checkPseudostateKind((Pseudostate) content, PseudostateKind.INITIAL);
    }
}

...
/**
 * <p>
 * RemoveJoinNodeAction class extends RemoveStateNodeAbstractAction abstract
 ...
 * @version 1.0
 */
public class RemoveJoinNodeAction extends RemoveStateNodeAbstractAction {
    /**
     * <p>
     * The presentation name for this action.
     * </p>
     */
    private static final String PRESENTATION_NAME = "Remove Join Node";

    /**
     * <p>
     * Construct a RemoveJoinNodeAction with the Pseudostate specified.
     * </p>
     *
     ...
     */
    public RemoveJoinNodeAction(Pseudostate state) {

...
/**
 * <p>
 * CutJoinNodeAction class extends CutStateNodeAbstractAction abstract
 * class. This action is used specially to cut Pseudostate node with
 * kind attribute equal to PseudostateKind.JOIN to the clipboard, this
 ...
 * @version 1.0
 */
public class CutJoinNodeAction extends CutStateNodeAbstractAction {
    /**
     * <p>
     * The presentation name for this action.
     * </p>
     */
    private static final String PRESENTATION_NAME = "Cut Join Node";

    /**
     * <p>
     * Construct a CutJoinNodeAction with the Pseudostate and Clipboard specified.
     * </p>
     *
     * <p>
     ...
     */
    public CutJoinNodeAction(Pseudostate state, Clipboard clipboard) {

...
/**
 * <p>
 * CutMergeNodeAction class extends CutStateNodeAbstractAction abstract
 * class. This action is used specially to cut Pseudostate node with
 * kind attribute equal to PseudostateKind.JUNCTION to the clipboard,
 ...
 * @version 1.0
 */
public class CutMergeNodeAction extends CutStateNodeAbstractAction {
    /**
     * <p>
     * The presentation name for this action.
     * </p>
     */
    private static final String PRESENTATION_NAME = "Cut Merge Node";

    /**
     * <p>
     * Construct a CutMergeNodeAction with the Pseudostate and Clipboard specified.
     * </p>
     *
     * <p>
     ...
     */
    public CutMergeNodeAction(Pseudostate state, Clipboard clipboard) {

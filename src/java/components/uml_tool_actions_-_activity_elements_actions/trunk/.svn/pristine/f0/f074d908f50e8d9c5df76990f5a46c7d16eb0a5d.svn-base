 ...
 * to PseudostateKind.JOIN retrieved from the clipboard into the
 ...
 * @version 1.0
 */
public class PasteJoinNodeAction extends PasteStateNodeAbstractAction {
    /**
     * <p>
     * The presentation name for this action.
     * </p>
     */
    private static final String PRESENTATION_NAME = "Paste Join Node";

    /**
     * <p>
     * Construct a PasteJoinNodeAction with the content and activityGraph specified.
     * </p>
     *
     ...
     * to PseudostateKind.JOIN
     */
    public PasteJoinNodeAction(Object content, ActivityGraph activityGraph) {
        super(PRESENTATION_NAME, content, activityGraph);

        Util.checkClassType(content, Pseudostate.class);
        Util.checkPseudostateKind((Pseudostate) content, PseudostateKind.JOIN);
    }
}

...
/**
 * <p>
 * AddDecisionNodeAction class extends AddStateNodeAbstractAction abstract class,
 * and this action is specifically used to add Pseudostate node whose kind attribute
 * equals to PseudostateKind.CHOICE in activity graph.
 * </p>
 *
 * <p>
 ...
 * @version 1.0
 */
public class AddDecisionNodeAction extends AddStateNodeAbstractAction {
    /**
     * <p>
     * The presentation name for this action.
     * </p>
     */
    private static final String PRESENTATION_NAME = "Add Decision Node";

    /**
     * <p>
     * Construct an AddDecisionNodeAction with the Pseudostate,
     ...
     */
    public AddDecisionNodeAction(Pseudostate state, ActivityGraph activityGraph, UMLModelManager manager) {

...
/**
 * <p>
 * CopyDecisionNodeAction class extends CopyStateNodeAbstractAction abstract
 * class. This action is used specially to copy Pseudostate node with kind
 * attribute equal to PseudostateKind.CHOICE to the clipboard.
 * </p>
 *
 * <p>
 ...
 * @version 1.0
 */
public class CopyDecisionNodeAction extends CopyStateNodeAbstractAction {
    /**
     * <p>
     * Construct a CopyDecisionNodeAction with the Pseudostate and Clipboard specified.
     * </p>
     *
     * <p>
     ...
     * argument's kind attribute doesn't equal to PseudostateKind.CHOICE, or
     * fail to get the system clipboard when the given clipboard is null
     */
    public CopyDecisionNodeAction(Pseudostate state, Clipboard clipboard) {

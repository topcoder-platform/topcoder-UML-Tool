...
/**
 * <p>
 * CopyObjectFlowStateAction class extends CopyStateNodeAbstractAction abstract
 * class. This action is used specially to copy ObjectFlowState node to the
 * clipboard.
 * </p>
 *
 * <p>
 ...
 * @version 1.0
 */
public class CopyObjectFlowStateAction extends CopyStateNodeAbstractAction {
    /**
     * <p>
     * Construct a CopyObjectFlowStateAction with the ObjectFlowState and
     * Clipboard specified.
     * </p>
     *
     * <p>
     ...
     */
    public CopyObjectFlowStateAction(ObjectFlowState state, Clipboard clipboard) {

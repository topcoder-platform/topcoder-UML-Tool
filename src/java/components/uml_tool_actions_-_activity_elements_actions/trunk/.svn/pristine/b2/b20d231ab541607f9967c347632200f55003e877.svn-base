...
/**
 * <p>
 * Failure test for <code>PasteAcceptEventActionAction</code>.
 * </p>
 *
 * @author restarter
 * @version 1.0
 */
public class PasteAcceptEventActionActionFailureTest extends TestCase {
     ...
     * <p>
     * Failure test for
     * <code>PasteAcceptEventActionAction(Object content, ActivityGraph activityGraph)</code>.
     * </p>
     * <p>
     * content is null, IllegalArgumentException is expected.
     * </p>
     */
    public void testPasteAcceptEventActionActionNullState() {
        try {
     ...
     * </p>
     */
    public void testPasteAcceptEventActionActionNullActivityGraph() {
        try {
            new PasteAcceptEventActionAction(state, null);
     ...
     * </p>
     */
    public void testPasteAcceptEventActionActionInvalidObject() {
        try {
            new PasteAcceptEventActionAction(new Object(), null);

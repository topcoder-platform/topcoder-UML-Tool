 ...
 * to PseudostateKind.JUNCTION retrieved from the clipboard into
 ...
 * @version 1.0
 */
public class PasteMergeNodeAction extends PasteStateNodeAbstractAction {
    /**
     * <p>
     * The presentation name for this action.
     * </p>
     */
    private static final String PRESENTATION_NAME = "Paste Merge Node";

    /**
     * <p>
     * Construct a PasteMergeNodeAction with the content and activityGraph specified.
     * </p>
     *
     ...
     */
    public PasteMergeNodeAction(Object content, ActivityGraph activityGraph) {
        super(PRESENTATION_NAME, content, activityGraph);

        Util.checkClassType(content, Pseudostate.class);
        Util.checkPseudostateKind((Pseudostate) content, PseudostateKind.JUNCTION);
    }
}

...
/**
 * <p>
 * AddJoinNodeAction class extends AddStateNodeAbstractAction abstract class,
 * and this action is specifically used to add Pseudostate node whose kind
 * attribute equals to PseudostateKind.JOIN in activity graph.
 * </p>
 *
 * <p>
 ...
 * @version 1.0
 */
public class AddJoinNodeAction extends AddStateNodeAbstractAction {
    /**
     * <p>
     * The presentation name for this action.
     * </p>
     */
    private static final String PRESENTATION_NAME = "Add Join Node";

    /**
     * <p>
     * Construct an AddJoinNodeAction with the Pseudostate,
     ...
     * argument's kind attribute doesn't equal to PseudostateKind.JOIN
     */
    public AddJoinNodeAction(Pseudostate state, ActivityGraph activityGraph, UMLModelManager manager) {

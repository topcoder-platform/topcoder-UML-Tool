...
/**
 * <p>
 * CopyInitialNodeAction class extends CopyStateNodeAbstractAction abstract
 * class. This action is used specially to copy Pseudostate node with kind
 * attribute equal to PseudostateKind.INITIAL to the clipboard.
 * </p>
 *
 * <p>
 ...
 * @version 1.0
 */
public class CopyInitialNodeAction extends CopyStateNodeAbstractAction {

    /**
     * <p>
     * Construct a CopyInitialNodeAction with the Pseudostate and Clipboard specified.
     * </p>
     *
     * <p>
     ...
     * argument's kind attribute doesn't equal to PseudostateKind.INITIAL, or
     * fail to get the system clipboard when the given clipboard is null
     */
    public CopyInitialNodeAction(Pseudostate state, Clipboard clipboard) {

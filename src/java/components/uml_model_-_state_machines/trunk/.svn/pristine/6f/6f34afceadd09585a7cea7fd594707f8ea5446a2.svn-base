...
/**
 * Failure test cases for class <code>SimpleStateImpl</code>.
 *
 * @author Chenhong
 * @version 1.0
 */
public class FailureTestSimpleStateImpl extends TestCase {
   ...
   *
   */
  public void testSimpleStateImpl_1() {
    Collection<Transition> outgoing = new ArrayList<Transition>();
    try {
      new SimpleStateImpl(compositeState, outgoing, null, stateMachine);
   ...
   *
   */
  public void testSimpleStateImpl_2() {
    Collection<Transition> incoming = new ArrayList<Transition>();

    try {
      new SimpleStateImpl(compositeState, null, incoming, stateMachine);
      fail("IllegalArgumentException is expected.");
    } catch (IllegalArgumentException e) {
      // Ok.
    }
   ...
   *
   */
  public void testSimpleStateImpl_3() {
    Collection<Transition> outgoing = new ArrayList<Transition>();
    ...
    try {
      new SimpleStateImpl(compositeState, outgoing, incoming, stateMachine);
      fail("IllegalArgumentException is expected.");
    } catch (IllegalArgumentException e) {
      // Ok.
    }
   ...
   *
   */
  public void testSimpleStateImpl_4() {
    Collection<Transition> outgoing = new ArrayList<Transition>();
    outgoing.add(null);

...
/**
 * <p>
 * Unit tests for {@link Uml1SemanticModelBridgeTransformer} class.
 * </p>
 *
 * @author TCSDEVELOPER
 * @version 1.0
 */
public class Uml1SemanticModelBridgeTransformerTest extends TransformerTestCase {
     ...
     * </p>
     */
    private Uml1SemanticModelBridge element;
    ...
    public static Test suite() {
        return new TestSuite(Uml1SemanticModelBridgeTransformerTest.class);
    }
    ...
    protected void setUp() throws Exception {
        super.setUp();
        element = createUml1SemanticModelBridge();
        transformer = new Uml1SemanticModelBridgeTransformer();
    ...
    /**
     * <p>
     * Test constructor for 'Uml1SemanticModelBridgeTransformer()' for accuracy.
     * </p>
     *
     * <p>
     * Verify : Uml1SemanticModelBridgeTransformer() is correct.
     * </p>
     */
    public void testUml1SemanticModelBridgeTransformer() {
        assertNotNull("Fail to create a Uml1SemanticModelBridgeTransformer instance.", transformer);
    }
    ...
    public void testTransform() throws Exception {
        ...
        validateUml1SemanticModelBridge(node, element);
    }
     ...
     *
     * <p>
     * It tests the case the The Uml1SemanticModelBridge is empty and transform() is correct.
     * </p>
     *
     * @throws Exception to Junit
     */
    public void testTransformWithEmptyUml1SemanticModelBridge() throws Exception {
        element = createEmptyUml1SemanticModelBridge();
        Node node = transformer.transform(element, document, d2XMITransformer);
        validateUml1SemanticModelBridge(node, element);
    }
}
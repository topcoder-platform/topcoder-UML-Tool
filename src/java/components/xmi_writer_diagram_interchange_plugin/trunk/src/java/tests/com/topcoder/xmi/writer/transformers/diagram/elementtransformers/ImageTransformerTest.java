...
/**
 * <p>
 * Unit tests for {@link ImageTransformer} class.
 * </p>
 *
 * @author TCSDEVELOPER
 * @version 1.0
 */
public class ImageTransformerTest extends TransformerTestCase {
    ...
    public static Test suite() {
        return new TestSuite(ImageTransformerTest.class);
    }
    ...
    /**
     * <p>
     * Test constructor for 'ImageTransformer()' for accuracy.
     * </p>
     *
     * <p>
     * Verify : ImageTransformer() is correct.
     * </p>
     */
    public void testImageTransformer() {
        assertNotNull("Fail to create a ImageTransformer instance.", transformer);
    }
     ...
     *
     * <p>
     * It tests the case that Image is empty( without any initialization and verifies
     * transform(Object, Document, Diagram2XMITransformer) is correct.
     * </p>
     * @throws Exception to Junit
     */
    public void testTransformWithEmptyImage() throws Exception {
        element = createEmptyImage();
        Node node = transformer.transform(element, document, d2XMITransformer);
        // check the structure of the XML Node
        validateImage(node, element);
    }

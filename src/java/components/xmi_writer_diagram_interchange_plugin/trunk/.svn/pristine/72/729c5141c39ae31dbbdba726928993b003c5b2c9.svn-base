...
/**
 * Accuracy test cases for class <code>GraphNodeTransformer</code>.
 *
 * @author Chenhong
 * @version 1.0
 */
public class TestGraphNodeTransformerAccuracy extends TestCase {
	/**
     * Represents the DiagramInterchangeElementTransformer instance for testing.
     */
	private DiagramInterchangeElementTransformer transformer = new GraphNodeTransformer();
	...
	public void testTransform() throws Exception {
		...
		assertEquals("the node name should  be UML:GraphicPrimitive", "UML:GraphNode", node.getNodeName());

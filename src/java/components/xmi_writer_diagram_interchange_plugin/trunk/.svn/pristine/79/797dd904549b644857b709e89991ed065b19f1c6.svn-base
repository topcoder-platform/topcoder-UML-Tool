...
/**
 * <p>
 * Unit tests for {@link PointTransformer} class.
 * </p>
 *
 * @author TCSDEVELOPER
 * @version 1.0
 */
public class PointTransformerTest extends TransformerTestCase {
    ...
    public static Test suite() {
        return new TestSuite(PointTransformerTest.class);
    }
    ...
    /**
     * <p>
     * Test constructor for 'PointTransformer()' for accuracy.
     * </p>
     *
     * <p>
     * Verify : PointTransformer() is correct.
     * </p>
     */
    public void testPointTransformer() {
        assertNotNull("Fail to create a PointTransformer instance.", transformer);
    }
     ...
     *
     * <p>
     * It tests the case that Point is empty( without any initialization and verifies
     * transform(Object, Document, Diagram2XMITransformer) is correct.
     * </p>
     * @throws Exception to Junit
     */
    public void testTransformWithEmptyPoint() throws Exception {
        element = createEmptyPoint();
        Node node = transformer.transform(element, document, d2XMITransformer);
        // check the structure of the XML Node
        validatePoint(node, element);
    }

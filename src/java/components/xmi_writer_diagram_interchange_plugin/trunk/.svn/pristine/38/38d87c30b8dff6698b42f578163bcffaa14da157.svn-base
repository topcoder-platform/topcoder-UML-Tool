...
/**
 * <p>
 * Unit tests for {@link CoreSemanticModelBridgeTransformer} class.
 * </p>
 *
 * @author TCSDEVELOPER
 * @version 1.0
 */
public class CoreSemanticModelBridgeTransformerTest extends TransformerTestCase {

    /**
     * <p>
     * The CoreSemanticModelBridge instance used for testing.
     * </p>
     */
    private CoreSemanticModelBridge element;
    ...
    public static Test suite() {
        return new TestSuite(CoreSemanticModelBridgeTransformerTest.class);
    }
    ...
    protected void setUp() throws Exception {
        super.setUp();
        element = createCoreSemanticModelBridge();
        transformer = new CoreSemanticModelBridgeTransformer();
    ...
    /**
     * <p>
     * Test constructor for 'CoreSemanticModelBridgeTransformer()' for accuracy.
     * </p>
     *
     * <p>
     * Verify : CoreSemanticModelBridgeTransformer() is correct.
     * </p>
     */
    public void testCoreSemanticModelBridgeTransformer() {
        assertNotNull("Fail to create a CoreSemanticModelBridgeTransformer instance.", transformer);
    }
     ...
     *
     * <p>
     * It tests the case the The CoreSemanticModelBridge is empty and transform() is correct.
     * </p>
     *
     * @throws Exception to Junit
     */
    public void testTransformWithEmptyBezierPoint() throws Exception {
        element = createEmptyCoreSemanticModelBridge();
        Node node = transformer.transform(element, document, d2XMITransformer);
        validateCoreSemanticModelBridge(node, element);
    }
}
...
/**
 * <p>
 * Unit tests for {@link SemanticModelBridgeTransformer} class.
 * </p>
 *
 * @author TCSDEVELOPER
 * @version 1.0
 */
public class SemanticModelBridgeTransformerTest extends TransformerTestCase {
     ...
     * </p>
     */
    private SemanticModelBridge element;
    ...
    public static Test suite() {
        return new TestSuite(SemanticModelBridgeTransformerTest.class);
    }
    ...
    protected void setUp() throws Exception {
        super.setUp();
        element = createSemanticModelBridge();
        transformer = new SemanticModelBridgeTransformer();
    ...
    /**
     * <p>
     * Test constructor for 'SemanticModelBridgeTransformer()' for accuracy.
     * </p>
     *
     * <p>
     * Verify : SemanticModelBridgeTransformer() is correct.
     * </p>
     */
    public void testSemanticModelBridgeTransformer() {
        assertNotNull("Fail to create a SemanticModelBridgeTransformer instance.", transformer);
    }
    ...
    public void testTransform() throws Exception {
        ...
        validateSemanticModelBridge(node, element);
    }
     ...
     *
     * <p>
     * It tests the case the The SemanticModelBridge is empty and transform() is correct.
     * </p>
     *
     * @throws Exception to Junit
     */
    public void testTransformWithEmptySemanticModelBridge() throws Exception {
        element = createEmptySemanticModelBridge();
        Node node = transformer.transform(element, document, d2XMITransformer);
        validateSemanticModelBridge(node, element);
    }
}
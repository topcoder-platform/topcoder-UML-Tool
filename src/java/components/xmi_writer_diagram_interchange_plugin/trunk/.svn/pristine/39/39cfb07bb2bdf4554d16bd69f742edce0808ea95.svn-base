...
/**
 * <p>
 * Unit tests for {@link TextElementTransformer} class.
 * </p>
 *
 * @author TCSDEVELOPER
 * @version 1.0
 */
public class TextElementTransformerTest extends TransformerTestCase {
    ...
    public static Test suite() {
        return new TestSuite(TextElementTransformerTest.class);
    }
    ...
    protected void setUp() throws Exception {
        ...
        transformer = new TextElementTransformer();
    ...
    /**
     * <p>
     * Test constructor for 'TextElementTransformer()' for accuracy.
     * </p>
     *
     * <p>
     * Verify : TextElementTransformer() is correct.
     * </p>
     */
    public void testTextElementTransformer() {
        assertNotNull("Fail to create a TextElementTransformer instance.", transformer);
    }
    ...
    public void testTransform() throws Exception {
        ...
        validateTextElement(node, element);
    }
     ...
     *
     * <p>
     * It tests the case that TextElement is empty( without any initialization and verifies
     * transform(Object, Document, Diagram2XMITransformer) is correct.
     * </p>
     * @throws Exception to Junit
     */
    public void testTransformWithEmptyTextElement() throws Exception {
        element = createEmptyTextElement();
        Node node = transformer.transform(element, document, d2XMITransformer);
        // check the structure of the XML Node
        validateTextElement(node, element);
    }

...
/**
 * <p>
 * Unit tests for {@link ReferenceTransformer} class.
 * </p>
 *
 * @author TCSDEVELOPER
 * @version 1.0
 */
public class ReferenceTransformerTest extends TransformerTestCase {
    ...
    public static Test suite() {
        return new TestSuite(ReferenceTransformerTest.class);
    }
    ...
    /**
     * <p>
     * Test constructor for 'ReferenceTransformer()' for accuracy.
     * </p>
     *
     * <p>
     * Verify : ReferenceTransformer() is correct.
     * </p>
     */
    public void testReferenceTransformer() {
        assertNotNull("Fail to create a ReferenceTransformer instance.", transformer);
    }
    ...
    public void testTransform() throws Exception {
        ...
        validateReference(node, element);
    }
}
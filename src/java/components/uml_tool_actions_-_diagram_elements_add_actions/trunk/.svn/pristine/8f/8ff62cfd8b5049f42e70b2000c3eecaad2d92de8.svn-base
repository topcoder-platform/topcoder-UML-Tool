 ...
 *
 * <p>
 * Note, the order of the first and the second SemanticModelElement does not matter.
 * </p>
 *
 * <p>
 ...
 * @version 1.0
 */
public class DefaultEdgeCompartmentExtractor extends AbstractCompartmentExtractor {
    /**
     * <p>
    ...
    /**
     * <p>
     * Create DefaultEdgeCompartmentExtractor with the element set to the given GraphEdge.
     * </p>
     *
     * @param edge the graph edge in which the compartment is to be extracted
     *
     * @throws IllegalArgumentException if edge if null
     */
    public DefaultEdgeCompartmentExtractor(GraphEdge edge) {
        super(edge);
    ...
    private StructureCompartmentExtractor getExtractorForName() {
        StructureCompartmentExtractor extractor = new StructureCompartmentExtractor((GraphElement) this.getElement(),
            null);
        extractor.addNextLevelSemanticModel("Name");

...
/**
 * <p>
 * Unit test cases for UpdateNamespaceAction.
 * </p>
 *
 * @author TCSDEVELOPER
 * @version 1.0
 */
public class UpdateNamespaceActionTests extends TestCase {
    /**
     * <p>
     * UpdateNamespaceAction instance for testing.
     * </p>
     */
    private UpdateNamespaceAction action;
    ...
    protected void setUp() {
        ...
        action = new UpdateNamespaceAction(extractor, newElement);
    }
    ...
    public static Test suite() {
        return new TestSuite(UpdateNamespaceActionTests.class);
    }

    /**
     * <p>
     * Tests ctor UpdateNamespaceAction#UpdateNamespaceAction(CompartmentExtractor,
     * GraphElement) for accuracy.
     * </p>
     *
     * <p>
     * Verify : the newly created UpdateNamespaceAction instance should not be null.
     * </p>
     */
    public void testCtor() {
        assertNotNull("Failed to create a new UpdateNamespaceAction instance.", action);
    }
    ...
    public void testCtor_NullExtractor() {
        try {
            new UpdateNamespaceAction(null, newElement);
     ...
     *
     * <p>
     * It tests the case that when newNamespace is null and expects IllegalArgumentException.
     * </p>
     */
    public void testCtor_NullNewNamespace() {
        try {
    ...
    /**
     * <p>
     * Tests UpdateNamespaceAction#execute() for accuracy.
     * </p>
     *
     * <p>
     * Verify : The namespace is updated and the action can be un-done.
     * </p>
     *
    ...
    public void testExecute() throws Exception {
        ...
        assertEquals("The first association end should be updated.", "updateNamespace", diagram.getName());
        assertTrue("The action should can be un-done.", action.canUndo());
    }

    /**
     * <p>
     * Tests UpdateNamespaceAction#execute() for failure.
     * </p>
     *
     * <p>

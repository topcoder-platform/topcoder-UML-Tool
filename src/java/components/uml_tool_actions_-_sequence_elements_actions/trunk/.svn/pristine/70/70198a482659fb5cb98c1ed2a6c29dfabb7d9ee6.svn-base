...
/**
 * <p>
 * Accuracy test for <code>{@link AddCreateMessageAction}</code> class.
 * </p>
 *
 * @author FireIce
 * @version 1.0
 */
public class AddCreateMessageActionAccuracyTests extends BaseTestCase {
    /**
    ...
    /**
     * <p>
     * Represents the <code>AddCreateMessageAction</code> instance used in
     * tests.
     * </p>
     */
    private AddCreateMessageAction action;
     ...
     * <p>
     * Accuracy test for
     * <code>{@link AddCreateMessageAction#AddCreateMessageAction(Stimulus, Collaboration, UMLModelManager)}</code>
     * constructor.
     * </p>
     *
     * @throws Exception pass any unexpected exception to JUnit.
    ...
    public void testCtorAccuracy() throws Exception {
        action = new AddCreateMessageAction(stimulus, collaboration, umlModelManager);
     ...
     * <p>
     * Accuracy test for
     * <code>{@link AddCreateMessageAction#getPresentationName()}</code>
     * method.
     * </p>
     *
     * @throws Exception pass any unexpected exception to JUnit.
    ...
    public void testGetPresentationNameAccuracy() throws Exception {
        ...
        assertEquals("incorrect presentation name", "Add Create Message", action.getPresentationName());
    }
}

 ...
 * @version 1.0
 */
public class CopyAsynchronousMessageActionFailureTest extends TestCase {
    /**
     * <p>
    ...
    public void testCtor1InvalidStimulus1() {
        try {
            new CopyAsynchronousMessageAction(stimulus);
     ...
     * <p>
     * Failure Test for
     * <code>CopyAsynchronousMessageAction(Stimulus stimulus, Clipboard clipboard)
     * </code>.
     * </p>
     * <p>
     * stimulus is null, IllegalArgumentException is expected.
    ...
    public void testCtor2NullStimulus() {
        try {
            new CopyAsynchronousMessageAction(null, clip);
            fail("stimulus is null, IllegalArgumentException is expected.");
        } catch (IllegalArgumentException e) {
            // expect
        } catch (SequenceConfigurationException e) {
    ...
    public void testCtor2NullClipboard() {
        try {
            new CopyAsynchronousMessageAction(stimulus, null);
            fail("stimulus is null, IllegalArgumentException is expected.");
        } catch (IllegalArgumentException e) {
            // expect
        } catch (SequenceConfigurationException e) {
    ...
    public void testCtor2InvalidStimulus1() {
        try {
            new CopyAsynchronousMessageAction(stimulus, clip);
            fail("stimulus is invalid, SequenceConfigurationException is expected.");
        } catch (IllegalArgumentException e) {
            fail("stimulus is invalid, SequenceConfigurationException is expected.");
        } catch (SequenceConfigurationException e) {

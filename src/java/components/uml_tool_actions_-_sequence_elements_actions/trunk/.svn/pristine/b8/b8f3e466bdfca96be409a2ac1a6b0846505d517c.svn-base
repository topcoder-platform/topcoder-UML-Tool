...
/**
 * <p>
 * Failure test for CopySynchronousMessageAction.
 * </p>
 *
 * @author restarter
 * @version 1.0
 */
public class CopySynchronousMessageActionFailureTest extends TestCase {
    /**
     * <p>
     ...
     * <p>
     * Failure Test for
     * <code>CopySynchronousMessageAction(Stimulus stimulus)</code>.
     * </p>
     * <p>
    ...
    public void testCtor1InvalidStimulus1() {
        try {
            new CopySynchronousMessageAction(stimulus);
     ...
     * <p>
     * Failure Test for
     * <code>CopySynchronousMessageAction(Stimulus stimulus, Clipboard clipboard)
     * </code>.
     * </p>
     * <p>
     * stimulus is null, IllegalArgumentException is expected.
    ...
    public void testCtor2NullStimulus() {
        try {
            new CopySynchronousMessageAction(null, clip);
            fail("stimulus is null, IllegalArgumentException is expected.");
        } catch (IllegalArgumentException e) {
            // expect
        } catch (SequenceConfigurationException e) {
     ...
     * <p>
     * Failure Test for
     * <code>CopySynchronousMessageAction(Stimulus stimulus, Clipboard clipboard)</code>.
     * </p>
     * <p>
     * stimulus is null, IllegalArgumentException is expected.
     * </p>
    ...
    public void testCtor2NullClipboard() {
        try {
            new CopySynchronousMessageAction(stimulus, null);
            fail("stimulus is null, IllegalArgumentException is expected.");
        } catch (IllegalArgumentException e) {
            // expect
        } catch (SequenceConfigurationException e) {
    ...
    public void testCtor2InvalidStimulus1() {
        try {
            new CopySynchronousMessageAction(stimulus, clip);
            fail("stimulus is invalid, SequenceConfigurationException is expected.");
        } catch (IllegalArgumentException e) {
            fail("stimulus is invalid, SequenceConfigurationException is expected.");
        } catch (SequenceConfigurationException e) {

...
/**
 * <p>
 * This class represents removing of return message. The constructor validates the message type and the class
 ...
 * @version 1.0
 */
public class RemoveReturnMessageAction extends RemoveMessageAction {
     ...
     * </p>
     */
    private static final String PRESENTATION_NAME = "Remove Return Message Action";

    /**
     * <p>
     * Constructs <code>RemoveReturnMessageAction</code> with <code>stimulus</code>. It ensures that the
     ...
     */
    public RemoveReturnMessageAction(Stimulus stimulus) throws SequenceConfigurationException {
        super(stimulus);

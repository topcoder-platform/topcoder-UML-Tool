...
/**
 * <p>
 * This class represents cutting of synchronous message. The constructor validates the message type and the
 ...
 * @version 1.0
 */
public class CutSynchronousMessageAction extends CutMessageAction {
     ...
     * </p>
     */
    private static final String PRESENTATION_NAME = "Cut Synchronous Message";

    /**
     * <p>
     * Constructs <code>CutSynchronousMessageAction</code> with the provided <code>stimulus</code>. It
     ...
     */
    public CutSynchronousMessageAction(Stimulus stimulus) throws SequenceConfigurationException {
        super(stimulus);
    ...
    /**
     * <p>
     * Constructs <code>CutSynchronousMessageAction</code> with the provided
     ...
     *             when instance of stimulus is incorrect for this action
     */
    public CutSynchronousMessageAction(Stimulus stimulus, Clipboard clipboard)
        throws SequenceConfigurationException {
     ...
     * </p>
     * <p>
     * <strong>Typical Return value:</strong> the string value describing this action.
     * </p>
     * <p>
     * </p>
     *

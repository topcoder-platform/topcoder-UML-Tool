...
/**
 * <p>
 * This class represents copying of synchronous message. The constructor validates the message type. All the
 ...
 * @version 1.0
 */
public class CopySynchronousMessageAction extends CopyMessageAction {
     ...
     */
    public CopySynchronousMessageAction(Stimulus stimulus) throws SequenceConfigurationException {
        super(stimulus);
     ...
     *             when instance of stimulus is incorrect for this action
     */
    public CopySynchronousMessageAction(Stimulus stimulus, Clipboard clipboard)
        throws SequenceConfigurationException {

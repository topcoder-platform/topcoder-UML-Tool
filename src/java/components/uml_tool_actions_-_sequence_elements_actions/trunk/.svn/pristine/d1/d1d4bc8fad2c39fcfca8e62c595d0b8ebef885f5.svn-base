...
/**
 * <p>
 * Failure test for CopySendSignalMessageAction.
 * </p>
 *
 * @author restarter
 * @version 1.0
 */
public class CopySendSignalMessageActionFailureTest extends TestCase {
    /**
     * <p>
     ...
     * <p>
     * Failure Test for
     * <code>CopySendSignalMessageAction(Stimulus stimulus)</code>.
     * </p>
     * <p>
    ...
    public void testCtor1InvalidStimulus1() {
        try {
            new CopySendSignalMessageAction(stimulus);
     ...
     * <p>
     * Failure Test for
     * <code>CopySendSignalMessageAction(Stimulus stimulus, Clipboard clipboard)
     * </code>.
     * </p>
     * <p>
     * stimulus is null, IllegalArgumentException is expected.
    ...
    public void testCtor2NullStimulus() {
        try {
            new CopySendSignalMessageAction(null, clip);
            fail("stimulus is null, IllegalArgumentException is expected.");
        } catch (IllegalArgumentException e) {
            // expect
        } catch (SequenceConfigurationException e) {
     ...
     * <p>
     * Failure Test for
     * <code>CopySendSignalMessageAction(Stimulus stimulus, Clipboard clipboard)</code>.
     * </p>
     * <p>
     * stimulus is null, IllegalArgumentException is expected.
     * </p>
    ...
    public void testCtor2NullClipboard() {
        try {
            new CopySendSignalMessageAction(stimulus, null);
            fail("stimulus is null, IllegalArgumentException is expected.");
        } catch (IllegalArgumentException e) {
            // expect
        } catch (SequenceConfigurationException e) {
    ...
    public void testCtor2InvalidStimulus1() {
        try {
            new CopySendSignalMessageAction(stimulus, clip);
            fail("stimulus is invalid, SequenceConfigurationException is expected.");
        } catch (IllegalArgumentException e) {
            fail("stimulus is invalid, SequenceConfigurationException is expected.");
        } catch (SequenceConfigurationException e) {

...
/**
 * <p>
 * This class represents removing of synchronous message. The constructor validates the message type and the
 ...
 * @version 1.0
 */
public class RemoveSynchronousMessageAction extends RemoveMessageAction {
     ...
     * </p>
     */
    private static final String PRESENTATION_NAME = "Remove Synchronous Message";

    /**
     * <p>
     * Constructs <code>RemoveSynchronousMessageAction</code> with <code>stimulus</code>. It ensures that
     ...
     */
    public RemoveSynchronousMessageAction(Stimulus stimulus) throws SequenceConfigurationException {
        super(stimulus);

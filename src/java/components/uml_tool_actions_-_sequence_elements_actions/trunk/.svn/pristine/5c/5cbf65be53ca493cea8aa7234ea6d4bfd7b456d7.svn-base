...
/**
 * <p>
 * Failure test for AddAsynchronousMessageAction.
 * </p>
 *
 * @author restarter
 * @version 1.0
 */
public class AddAsynchronousMessageActionFailureTest extends TestCase {
    /**
     * <p>
     ...
     * <code>
     * AddAsynchronousMessageAction(Stimulus stimulus, Collaboration collaboration, UMLModelManager manager)</code>.
     * </p>
     * <p>
     ...
     * Failure Test for the
     * <code>
     * AddCreateMessageAction(Stimulus stimulus, Collaboration collaboration, UMLModelManager manager)</code>.
     * </p>
     * <p>
     * instance of stimulus is incorrect for this action,
     * SequenceConfigurationException is expected.
    ...
    public void testCtorInvalidStimulus2() {
        try {
            ...
            Procedure pro = new ProcedureImpl();
            st.setDispatchAction(pro);
            new AddAsynchronousMessageAction(st, collaboration, manager);
            fail("instance of stimulus is incorrect for this action, SequenceConfigurationException is expected.");
        } catch (IllegalArgumentException e) {
            fail("NO IllegalArgumentException is expected.");
        } catch (SequenceConfigurationException se) {

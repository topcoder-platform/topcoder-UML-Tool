...
/**
 * <p>
 * Failure test for RemoveSendSignalMessageAction.
 * </p>
 *
 * @author restarter
 * @version 1.0
 */
public class RemoveSendSignalMessageActionFailureTest extends TestCase {
    ...
    public void testCtorInvalidStimulus2() {
        try {
            ...
            procedure.setAction(action);
            stimulus.setDispatchAction(procedure);
            new RemoveSendSignalMessageAction(stimulus);

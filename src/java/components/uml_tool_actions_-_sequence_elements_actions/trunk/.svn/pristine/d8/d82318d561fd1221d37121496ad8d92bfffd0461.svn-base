...
/**
 * <p>
 * This class represents removing of asynchronous message. The constructor validates the message type and the
 ...
 * @version 1.0
 */
public class RemoveAsynchronousMessageAction extends RemoveMessageAction {
     ...
     * </p>
     */
    private static final String PRESENTATION_NAME = "Remove Asynchronous Message";

    /**
     * <p>
     * Constructs <code>RemoveAsynchronousMessageAction</code> with <code>stimulus</code>. It ensures
     * that the given stimulus is of correct message type.
     * </p>
     *
     * @param stimulus
     ...
     */
    public RemoveAsynchronousMessageAction(Stimulus stimulus) throws SequenceConfigurationException {
        super(stimulus);

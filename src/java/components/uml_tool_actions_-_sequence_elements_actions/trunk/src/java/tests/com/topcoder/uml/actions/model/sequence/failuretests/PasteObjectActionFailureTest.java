 ...
 * @version 1.0
 */
public class PasteObjectActionFailureTest extends TestCase {
    /**
     * <p>
     ...
     * <code>PasteObjectAction(Transferable transferable, Collaboration collaboration)</code>.
     * </p>
     * <p>
    ...
    public void testCtorNullCollaboration() {
        try {
            new PasteObjectAction(transferable, null);
            fail("transferable is null, IllegalArgumentException is expected.");
        } catch (IllegalArgumentException e) {
            // expect
        } catch (SequenceConfigurationException se) {

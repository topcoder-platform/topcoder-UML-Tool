...
/**
 * <p>
 * This class represents cutting of return message. The constructor validates the message type and the class
 ...
 * @version 1.0
 */
public class CutReturnMessageAction extends CutMessageAction {
    /**
     * <p>
     * Represents human readable description of this action.
     * </p>
     */
    private static final String PRESENTATION_NAME = "Cut Return Message Action";

    /**
     * <p>
     * Constructs <code>CutReturnMessageAction</code> with the provided <code>stimulus</code>. It ensures
     ...
     */
    public CutReturnMessageAction(Stimulus stimulus) throws SequenceConfigurationException {
        super(stimulus);
    ...
    /**
     * <p>
     * Constructs <code>CutReturnMessageAction</code> with the provided <code>stimulus and clipboard</code>.
     ...
     *             when instance of stimulus is incorrect for this action
     */
    public CutReturnMessageAction(Stimulus stimulus, Clipboard clipboard) throws SequenceConfigurationException {

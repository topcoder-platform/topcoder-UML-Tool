...
/**
 * <p>
 * This class represents pasting of synchronous message. The constructor validates the message type and the
 ...
 * @version 1.0
 */
public class PasteSynchronousMessageAction extends PasteMessageAction {
     ...
     * </p>
     */
    private static final String PRESENTATION_NAME = "Paste Synchronous Message";

    /**
     * <p>
     * Constructs <code>PasteSynchronousMessageAction</code> with the provided <code>transferable</code>
     ...
     */
    public PasteSynchronousMessageAction(Transferable transferable, Collaboration collaboration)
        throws SequenceConfigurationException {
        super(transferable, collaboration, CollaborationTransfer.SYNCHRONOUS_MESSAGE_FLAVOR);
        // check the message type
        Helper.checkMessage(getMessageUtil(), getStimulus(), Helper.SYNCHRONOUS_MESSAGE);
    }

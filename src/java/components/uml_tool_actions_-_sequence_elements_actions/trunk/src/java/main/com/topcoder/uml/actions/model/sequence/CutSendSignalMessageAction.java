...
/**
 * <p>
 * This class represents cutting of send signal message. The constructor validates the message type and the
 ...
 * @version 1.0
 */
public class CutSendSignalMessageAction extends CutMessageAction {
     ...
     * </p>
     */
    private static final String PRESENTATION_NAME = "Cut Send Signal Message";

    /**
     * <p>
     * Constructs <code>CutSendSignalMessageAction</code> with the provided <code>stimulus</code>. It
     ...
     */
    public CutSendSignalMessageAction(Stimulus stimulus) throws SequenceConfigurationException {
        super(stimulus);
    ...
    /**
     * <p>
     * Constructs <code>CutSendSignalMessageAction</code> with the provided
     ...
     *             when instance of stimulus is incorrect for this action
     */
    public CutSendSignalMessageAction(Stimulus stimulus, Clipboard clipboard)
        throws SequenceConfigurationException {

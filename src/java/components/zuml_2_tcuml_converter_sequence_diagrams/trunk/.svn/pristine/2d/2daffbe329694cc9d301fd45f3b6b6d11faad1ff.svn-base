...
public abstract class DefaultXMIConverter implements XMIConverter {
     ...
     * not called if the previous chain deosn't call this converter.
     * </p>
     *
     ...
     * error) or reached the end of input. This method may be not called if the previous chain deosn't
     * call this converter.
     * </p>
     *
     * @param chain the next chain of the chains of converters
     ...
     * method may be not called if the previous chain deosn't call this converter.
     * </p>
     *
     * @param uri
     *        the Namespace URI, or the empty string if the element has no Namespace URI
     ...
     * useful information. This method may be not called if the previous chain deosn't call
     * this converter.
     * </p>
     *

 ...
 * pair of keys is (&ldquo;fill&rdquo;, &ldquo;FILL_COLOR&rdquo;), it will replace the property
 * (&ldquo;fill&rdquo;, &ldquo;#0000000&rdquo;) with (&ldquo;FILL_COLOR&rdquo;,&ldquo;#0000000&rdquo;).
 * This is needed because the properties of the graph nodes from the .zuml have the same meaning
 * as those from .tcuml, only different keys or different format for the values.
 * </p>
 *
 * <p>
...
public class GraphPropertiesConverter extends DefaultXMIConverter {
        ...
        if (property != null) {
            for (String value : property.getValues()) {
                ...
                if (value.indexOf(":") != -1) {
                    ...
                    String identifier = value.substring(value.indexOf(":") + 1);

                    //The value should be in format like "key:identifier", there should not be the second ":"
                    //And key and identifier cannot be empty
                    if (key.equals("") || identifier.equals("") ||
                            (identifier.indexOf(":") != -1)) {
                        throw new XMIConverterConfigurationException(
                            "The key for transformers should be correct.");
                    }

                    obj = of.createObject(key, identifier);
                } else {
                    obj = of.createObject(value);
                }
     ...
     * (&ldquo;fill&rdquo;, &ldquo;FILL_COLOR&rdquo;), it will replace the property
     * (&ldquo;fill&rdquo;, &ldquo;#0000000&rdquo;) with (&ldquo;FILL_COLOR&rdquo;,&ldquo;#0000000&rdquo;).
     * This is needed because the properties of the graph nodes from the .zuml have the same meaning
     * as those from .tcuml, only different keys or different format for the values.
     * </p>
     * <p>Note: the property values will be first transformed because the keys may be changed.</p>
     *
     * @param uri

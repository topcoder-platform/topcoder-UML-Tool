...
public class EnumerationImpl extends DataTypeImpl implements Enumeration {
    ...
    /**
     * <p>
     * Represents a list of EnumationLiteral elements, each specifying a
     * possible value of an instance of the enumeration element. It will support
     * EnumerationLiteral elements.
     * </p>
     */

...
/**
 * <p>
 * This class extends from PasteAction and used for adding Abstraction instance
 ...
 * @version 1.0
 */
public class PasteAbstractionAction extends PasteAction {
     ...
     * </p>
     */
    private static final String PRESENTATION_NAME = "Paste Abstraction";
     ...
     */
    public PasteAbstractionAction(Transferable transferable, Namespace namespace) throws InvalidDataContentException {
        super(transferable, ClassElementsTransfer.ABSTRACTION_FLAVOR, new AbstractionUtil(), namespace);
    }

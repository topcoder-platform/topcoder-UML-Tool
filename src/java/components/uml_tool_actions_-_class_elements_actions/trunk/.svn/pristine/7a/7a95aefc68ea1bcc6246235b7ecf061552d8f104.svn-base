...
/**
 * <p>
 * This class extends from PasteAction and used for adding Package instance to
 ...
 * @version 1.0
 */
public class PastePackageAction extends PasteAction {
     ...
     * </p>
     */
    private static final String PRESENTATION_NAME = "Paste Package";
     ...
     */
    public PastePackageAction(Transferable transferable, Namespace namespace) throws InvalidDataContentException {
        super(transferable, ClassElementsTransfer.PACKAGE_FLAVOR, new PackageUtil(), namespace);
    }

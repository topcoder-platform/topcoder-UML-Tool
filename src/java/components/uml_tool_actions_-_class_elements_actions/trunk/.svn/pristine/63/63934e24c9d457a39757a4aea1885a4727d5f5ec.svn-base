...
/**
 * <p>
 * This class extends from RemoveAction and used for removing Association
 ...
 * @version 1.0
 */
public class RemoveAssociationAction extends RemoveAction {
     ...
     * </p>
     */
    private static final String PRESENTATION_NAME = "Remove Association";
     ...
     */
    public RemoveAssociationAction(Association association) {
        super(association, new AssociationUtil());
    }

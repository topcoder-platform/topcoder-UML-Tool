...
/**
 * <p>
 * This class extends from PasteAction and used for adding Class instance to
 ...
 * @version 1.0
 */
public class PasteExceptionAction extends PasteAction {
     ...
     * </p>
     */
    private static final String PRESENTATION_NAME = "Paste Exception";
     ...
     */
    public PasteExceptionAction(Transferable transferable, Namespace namespace) throws InvalidDataContentException {
        super(transferable, ClassElementsTransfer.EXCEPTION_FLAVOR, new ExceptionUtil(), namespace);
    }

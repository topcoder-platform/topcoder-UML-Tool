...
import com.topcoder.uml.model.commonbehavior.instances.*;
 ...
 * @version 1.0
 */
public class MockInstanceImpl implements Instance {
    /**
     * <p>
     ...
     */
    public Classifier getClassifier(){return null;}
     ...
     * @throws IllegalArgumentException if ownedLink is null
     */
    public boolean removeOwnedLink(Link ownedLink){return false;}
     ...
     * @throws IllegalArgumentException if ownedLinks is null or it contains null elements
     */
    public boolean removeOwnedLinks(Collection<Link> ownedLinks){return false;}
     ...
     */
    public Collection<Link> getOwnedLinks(){return null;}
     ...
     * @throws IllegalArgumentException if ownedLink is null
     */
    public boolean containsOwnedLink(Link ownedLink){return false;}
     ...
     */
    public int countOwnedLinks(){return 0;}
     ...
     * @throws IllegalArgumentException if linkEnd is null
     */
    public boolean removeLinkEnd(LinkEnd linkEnd){return false;}
     ...
     * @throws IllegalArgumentException if linkEnds is null or it contains null elements
     */
    public boolean removeLinkEnds(Collection<LinkEnd> linkEnds){return false;}
     ...
     */
    public Collection<LinkEnd> getLinkEnds(){return null;}
     ...
     * @throws IllegalArgumentException if linkEnd is null
     */
    public boolean containsLinkEnd(LinkEnd linkEnd){return false;}
     ...
     * @return the number of elements in the collection
     */
    public int countLinkEnds(){return 0;}
     ...
     * @throws IllegalArgumentException if sendStimulus is null
     */
    public boolean removeSendStimulus(Stimulus sendStimulus){return false;}
     ...
     * @throws IllegalArgumentException if sendStimuli is null or it contains null elements
     */
    public boolean removeSendStimuli(Collection<Stimulus> sendStimuli){return false;}
     ...
     */
    public Collection<Stimulus> getSendStimuli(){return null;}
     ...
     * @throws IllegalArgumentException if sendStimulus is null
     */
    public boolean containsSendStimulus(Stimulus sendStimulus){return false;}
     ...
     * @return the number of elements in the collection
     */
    public int countSendStimuli(){return 0;}
     ...
     * @throws IllegalArgumentException if receiveStimulus is null
     */
    public boolean removeReceiveStimulus(Stimulus receiveStimulus){return false;}
     ...
     * @throws IllegalArgumentException if receiveStimuli is null or it contains null elements
     */
    public boolean removeReceiveStimuli(Collection<Stimulus> receiveStimuli){return false;}
     ...
     */
    public Collection<Stimulus> getReceiveStimuli(){return null;}
     ...
     * @throws IllegalArgumentException if receiveStimulus is null
     */
    public boolean containsReceiveStimulus(Stimulus receiveStimulus){return false;}
     ...
     * @return the number of elements in the collection
     */
    public int countReceiveStimuli(){return 0;}

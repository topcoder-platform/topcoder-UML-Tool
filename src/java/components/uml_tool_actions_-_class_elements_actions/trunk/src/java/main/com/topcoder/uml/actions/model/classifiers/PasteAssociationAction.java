...
/**
 * <p>
 * This class extends from PasteAction and used for adding Association instance
 ...
 * @version 1.0
 */
public class PasteAssociationAction extends PasteAction {
     ...
     * </p>
     */
    private static final String PRESENTATION_NAME = "Paste Association";
     ...
     */
    public PasteAssociationAction(Transferable transferable, Namespace namespace) throws InvalidDataContentException {
        super(transferable, ClassElementsTransfer.ASSOCIATION_FLAVOR, new AssociationUtil(), namespace);
    }

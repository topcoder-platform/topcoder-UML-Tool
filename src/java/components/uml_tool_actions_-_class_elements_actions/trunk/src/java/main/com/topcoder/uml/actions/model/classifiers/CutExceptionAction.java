 ...
 * super class. Also it provide checking if given Class instance is exception.
 * </p>
 * <p>
 ...
 * @version 1.0
 */
public class CutExceptionAction extends CutAction {
     ...
     * </p>
     */
    private static final String PRESENTATION_NAME = "Cut Exception";
     ...
     */
    public CutExceptionAction(com.topcoder.uml.model.core.classifiers.Class exception)
     ...
     *             if given class is not exception
     */
    public CutExceptionAction(com.topcoder.uml.model.core.classifiers.Class exception, Clipboard clipboard)
            throws InvalidDataContentException {
        super(exception, new ExceptionUtil(), clipboard);

        ExceptionUtil util = (ExceptionUtil) this.getClassToolUtil();

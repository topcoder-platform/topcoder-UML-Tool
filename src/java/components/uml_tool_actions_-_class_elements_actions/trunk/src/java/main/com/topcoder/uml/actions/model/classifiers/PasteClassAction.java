 ...
 * @version 1.0
 */
public class PasteClassAction extends PasteAction {
     ...
     * </p>
     */
    private static final String PRESENTATION_NAME = "Paste Class";
     ...
     */
    public PasteClassAction(Transferable transferable, Namespace namespace) throws InvalidDataContentException {
        super(transferable, ClassElementsTransfer.CLASS_FLAVOR, new ClassUtil(), namespace);
    }

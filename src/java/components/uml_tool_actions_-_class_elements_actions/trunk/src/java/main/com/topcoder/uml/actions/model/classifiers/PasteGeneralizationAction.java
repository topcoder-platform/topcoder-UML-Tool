...
/**
 * <p>
 * This class extends from PasteAction and used for adding Generalization
 * instance to model or namespace from clipboard. Its methods provide only
 ...
 * @version 1.0
 */
public class PasteGeneralizationAction extends PasteAction {
     ...
     * </p>
     */
    private static final String PRESENTATION_NAME = "Paste Generalization";
     ...
     */
    public PasteGeneralizationAction(Transferable transferable, Namespace namespace)
    throws InvalidDataContentException {
        super(transferable, ClassElementsTransfer.GENERALIZATION_FLAVOR, new GeneralizationUtil(), namespace);
    }

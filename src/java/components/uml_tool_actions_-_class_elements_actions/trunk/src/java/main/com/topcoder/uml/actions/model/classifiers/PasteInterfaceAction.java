...
/**
 * <p>
 * This class extends from PasteAction and used for adding Interface instance to
 * model or namespace from clipboard. Its methods provide only proper
 ...
 * @version 1.0
 */
public class PasteInterfaceAction extends PasteAction {
     ...
     * </p>
     */
    private static final String PRESENTATION_NAME = "Paste Interface";
     ...
     */
    public PasteInterfaceAction(Transferable transferable, Namespace namespace) throws InvalidDataContentException {
        super(transferable, ClassElementsTransfer.INTERFACE_FLAVOR, new InterfaceUtil(), namespace);
    }

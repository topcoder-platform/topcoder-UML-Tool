...
/**
 * <p>
 * Unit tests for <code>ZUMLActivityFinalNodeImpl</code> class.
 * </p>
 *
 * @author zhengjuyu
 * @version 1.0
 */
public class ZUMLActivityFinalNodeImplUnitTest extends TestCase {
    /**
    ...
    public static Test suite() {
        return new TestSuite(ZUMLActivityFinalNodeImplUnitTest.class);
    }

    /**
     * <p>
     * Accuracy test for constructor <code>ZUMLActivityFinalNodeImpl()</code>.
     * </p>
     *
     * <p>
    ...
    public void testCtor() {
        ZUMLActivityNode node = new ZUMLActivityFinalNodeImpl();
        assertNotNull("Unable to create ZUMLActivityFinalNodeImpl instance.",
            node);
    }
     ...
     *
     * <p>
     * Verify that the returned ModelElement is instance of FinalState.
     * And verify that simple attributes are copied to the converted instance.
     * </p>
     */
    public void testConvertToTCUML1() {
        AbstractZUMLActivityNode node = new ZUMLActivityFinalNodeImpl();

...
/**
 * <p>
 * Unit tests for <code>ZUMLSendSignalActionImpl</code> class.
 * </p>
 *
 * @author zhengjuyu
 * @version 1.0
 */
public class ZUMLSendSignalActionImplUnitTest extends TestCase {
    /**
    ...
    public static Test suite() {
        return new TestSuite(ZUMLSendSignalActionImplUnitTest.class);
    }

    /**
     * <p>
     * Accuracy test for constructor <code>ZUMLSendSignalActionImpl()</code>.
     * </p>
     *
     * <p>
    ...
    public void testCtor() {
        ZUMLActivityNode node = new ZUMLSendSignalActionImpl();
        assertNotNull("Unable to create ZUMLSendSignalActionImpl instance.",
            node);
    }
     ...
     * taggedValue with dataValue being "Ture" and type being SendSignalAction TagDefinition.
    ...
    public void testConvertToTCUML1() {
        ...
        assertTrue("The ZUMLSendSignalActionImpl should be converted to FinalState class.",
        ...
        assertEquals("Its type's tagType is SendSignalAction.",
            "SendSignalAction", taggedValue.getType().getTagType());

        //Verify that the simple attributes are copied.
        assertEquals("The name should match.", "action", element.getName());

...
/**
 * <p>
 * Unit tests for <code>ZUMLPinNodeImpl</code> class.
 * </p>
 *
 * @author zhengjuyu
 * @version 1.0
 */
public class ZUMLPinNodeImplUnitTest extends TestCase {
    /**
    ...
    public static Test suite() {
        return new TestSuite(ZUMLPinNodeImplUnitTest.class);
    }

    /**
     * <p>
     * Accuracy test for constructor <code>ZUMLPinNodeImpl()</code>.
     * </p>
     *
     * <p>
    ...
    public void testCtor() {
        ZUMLActivityNode node = new ZUMLPinNodeImpl();
        assertNotNull("Unable to create ZUMLPinNodeImpl instance.", node);
    }

    /**
     * <p>
     * Accuracy test for <code>setUpperBound(ZUMLOpaqueExpression)</code>.
     * </p>
     *
     * <p>
     * Verify that the upperBound is set successfully.
     * </p>
     */
    public void testSetUpperBound() {
        ...
        node.setUpperBound(expression);

        assertEquals("The upperBound should match.", expression,
            node.getUpperBound());
    }

    /**
     * <p>
     * Failure test for <code>setUpperBound(ZUMLOpaqueExpression)</code>.
     * </p>
     *
     * <p>
     * Failure cause: If the upperBound is null, IllegalArgumentException is expected.
     * </p>
     */
    public void testSetUpperBound_Failure() {
        try {
            ZUMLPinNodeImpl node = new ZUMLPinNodeImpl();
            node.setUpperBound(null);
    ...
    /**
     * <p>
     * Accuracy test for <code>getUpperBound()</code>.
     * </p>
     *
     * <p>
     * Verify that the upperBound is got successfully.
     * </p>
     */
    public void testGetUpperBound() {
        ZUMLPinNodeImpl node = new ZUMLPinNodeImpl();

        assertNull("The upperBound's initial value is null.",
            node.getUpperBound());
     ...
     *
     * <p>
     * Verify that the returned ModelElement is instance of SimpleState, and it has one
     * taggedValue with dataValue being "ObjectFlowStateNode" and type being "ObjectFlowStateType"
     * TagDefinition. And verify that simple attributes are copied to the converted instance.
     * </p>
     */
    public void testConvertToTCUML1() {
        AbstractZUMLActivityNode node = new ZUMLPinNodeImpl();
        ...
        assertTrue("The ZUMLPinNodeImpl should be converted to SimpleState class.",
        ...
        TaggedValue taggedValue = (TaggedValue) element.getTaggedValues()
                                                       .toArray()[0];
        assertEquals("The data value is ObjectFlowStateNode.",
            "ObjectFlowStateNode", taggedValue.getDataValue());
        assertEquals("Its type's tagType is 'ObjectFlowStateType'",
            "ObjectFlowStateType", taggedValue.getType().getTagType());

        //Verify that the simple attributes are copied.
        assertEquals("The name should match.", "pin", element.getName());

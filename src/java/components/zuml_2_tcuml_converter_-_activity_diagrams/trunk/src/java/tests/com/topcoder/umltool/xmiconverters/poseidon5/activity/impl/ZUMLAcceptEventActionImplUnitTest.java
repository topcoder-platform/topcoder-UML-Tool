...
/**
 * <p>
 * Unit tests for <code>ZUMLAcceptEventActionImpl</code> class.
 * </p>
 *
 * @author zhengjuyu
 * @version 1.0
 */
public class ZUMLAcceptEventActionImplUnitTest extends TestCase {
    /**
    ...
    public static Test suite() {
        return new TestSuite(ZUMLAcceptEventActionImplUnitTest.class);
    }

    /**
     * <p>
     * Accuracy test for constructor <code>ZUMLAcceptEventActionImpl()</code>.
     * </p>
     *
     * <p>
    ...
    public void testCtor() {
        ZUMLActivityNode node = new ZUMLAcceptEventActionImpl();
        assertNotNull("Unable to create ZUMLAcceptEventActionImpl instance.",
            node);
    }
     ...
     * taggedValue with dataValue being "Ture" and type being AcceptEventAction TagDefinition.
     * And verify that simple attributes are copied to the converted instance.
     * </p>
     */
    public void testConvertToTCUML1() {
        AbstractZUMLActivityNode node = new ZUMLAcceptEventActionImpl();
        ...
        assertTrue("The ZUMLAcceptEventActionImpl should be converted to SimpleState class.",
        ...
        TaggedValue taggedValue = (TaggedValue) element.getTaggedValues()
                                                       .toArray()[0];
        assertEquals("The data value is True.", "True",
            taggedValue.getDataValue());
        assertEquals("Its type's tagType is AcceptEventAction.",
            "AcceptEventAction", taggedValue.getType().getTagType());

...
/**
 * <p>
 * Mock implementation of <code>AbstractZUMLOpaqueExpression</code> class. It provides an empty implementation of
 * convertToTCUML(). It's just used for testing <code>AbstractZUMLOpaqueExpression</code> class.
 * </p>
 * 
 * @author iRabbit
 * @version 1.0

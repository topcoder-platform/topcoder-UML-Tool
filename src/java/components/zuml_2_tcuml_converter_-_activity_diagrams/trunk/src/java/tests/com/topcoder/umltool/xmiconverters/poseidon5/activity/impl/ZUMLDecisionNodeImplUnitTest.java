...
/**
 * <p>
 * Unit tests for <code>ZUMLDecisionNodeImpl</code> class.
 * </p>
 *
 * @author zhengjuyu
 * @version 1.0
 */
public class ZUMLDecisionNodeImplUnitTest extends TestCase {
    /**
    ...
    public static Test suite() {
        return new TestSuite(ZUMLDecisionNodeImplUnitTest.class);
    }

    /**
     * <p>
     * Accuracy test for constructor <code>ZUMLDecisionNodeImpl()</code>.
     * </p>
     *
     * <p>
    ...
    public void testCtor() {
        ZUMLActivityNode node = new ZUMLDecisionNodeImpl();
        assertNotNull("Unable to create ZUMLDecisionNodeImpl instance.", node);
    }
     ...
     * kind is PseudostateKind.CHOICE. And verify that simple attributes are copied
     * to the converted instance.
     * </p>
     */
    public void testConvertToTCUML1() {
        AbstractZUMLActivityNode node = new ZUMLDecisionNodeImpl();
        ...
        assertTrue("The ZUMLDecisionNodeImpl should be converted to Pseudostate class.",
            element instanceof Pseudostate);

        assertEquals("The kind of the state is PseudostateKind.CHOICE",
            PseudostateKind.CHOICE, ((Pseudostate) element).getKind());

        assertEquals("The name should match.", "decision", element.getName());

...
/**
 * <p>
 * This class represents an UML2:MergeNode element. It will be used by the XMI Reader and its
 ...
 * @version 1.0
 */
public class ZUMLMergeNodeImpl extends AbstractZUMLActivityNode {
    /**
     * <p>Serial version uid for the Serializable class.</p>
     */
    private static final long serialVersionUID = 6181573939921653531L;
     ...
     */
    public ZUMLMergeNodeImpl() {
        super();
    }

    /**
     * <p>
     * This method converts the current ZUMLMergeNodeImpl representation of an
     * UML2:MergeNode zuml element into the equivalent tcuml instance.
     * </p>
     *
     * <p>
    ...
    public ModelElement convertToTCUML() {
        if (transformed == null) {
            transformed = Helper.createPseudostate(this, PseudostateKind.JUNCTION);
        }

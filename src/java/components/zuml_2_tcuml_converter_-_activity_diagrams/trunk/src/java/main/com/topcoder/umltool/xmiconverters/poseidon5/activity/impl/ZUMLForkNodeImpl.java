...
/**
 * <p>
 * This class represents an UML2:ForkNode element. It will be used by the XMI Reader and
 ...
 * @version 1.0
 */
public class ZUMLForkNodeImpl extends AbstractZUMLActivityNode {
    /**
     * <p>Serial version uid for the Serializable class.</p>
     */
    private static final long serialVersionUID = 8961952418038488969L;
     ...
     */
    public ZUMLForkNodeImpl() {
        super();
    }

    /**
     * <p>
     * This method converts the current ZUMLForkNodeImpl representation of an
     * UML2:ForkNode zuml element into the equivalent tcuml instance.
     * </p>
     *
     * <p>
    ...
    public ModelElement convertToTCUML() {
        if (transformed == null) {
            transformed = Helper.createPseudostate(this, PseudostateKind.FORK);
        }

...
/**
 * <p>
 * Unit tests for <code>ZUMLActivityEdgeImpl</code> class.
 * </p>
 *
 * @author zhengjuyu
 * @version 1.0
 */
public class ZUMLActivityEdgeImplUnitTest extends TestCase {
    /**
    ...
    public static Test suite() {
        return new TestSuite(ZUMLActivityEdgeImplUnitTest.class);
    }

    /**
     * <p>
     * Accuracy test for constructor <code>ZUMLActivityEdgeImpl()</code>.
     * </p>
     *
     * <p>
    ...
    public void testCtor() {
        ...
        assertNotNull("Unable to create ZUMLActivityEdgeImpl instance.", edge);
    }

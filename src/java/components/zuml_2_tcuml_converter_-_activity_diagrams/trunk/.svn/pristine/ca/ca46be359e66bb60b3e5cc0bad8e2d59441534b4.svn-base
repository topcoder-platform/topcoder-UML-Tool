...
/**
 * <p>
 * Unit tests for <code>ZUMLMergeNodeImpl</code> class.
 * </p>
 *
 * @author zhengjuyu
 * @version 1.0
 */
public class ZUMLMergeNodeImplUnitTest extends TestCase {
    /**
    ...
    public static Test suite() {
        return new TestSuite(ZUMLMergeNodeImplUnitTest.class);
    }

    /**
     * <p>
     * Accuracy test for constructor <code>ZUMLMergeNodeImpl()</code>.
     * </p>
     *
     * <p>
    ...
    public void testCtor() {
        ZUMLActivityNode node = new ZUMLMergeNodeImpl();
        assertNotNull("Unable to create ZUMLMergeNodeImpl instance.", node);
    }
     ...
     * kind is PseudostateKind.JUNCTION. And verify that simple attributes are copied
     * to the converted instance.
     * </p>
     */
    public void testConvertToTCUML1() {
        AbstractZUMLActivityNode node = new ZUMLMergeNodeImpl();
        ...
        assertTrue("The ZUMLMergeNodeImpl should be converted to Pseudostate class.",
            element instanceof Pseudostate);

        assertEquals("The kind of the state is PseudostateKind.JUNCTION",
            PseudostateKind.JUNCTION, ((Pseudostate) element).getKind());

        assertEquals("The name should match.", "merge", element.getName());

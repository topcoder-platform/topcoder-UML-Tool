...
/**
 * <p>
 * This is the mock class of DefaultXMIHandler. It will used for demo only.
 * </p>
 *
 *
 * @author TCSDEVELOPER
 * @version 1.0
 */
public class StereotypeHandler extends DefaultXMIHandler {
     /**
     * <p>
     * Creates this handler with all properties null.
     * </p>
     */
     ...
     */
    public StereotypeHandler(XMIReader reader) {
        super(reader);
    }
}

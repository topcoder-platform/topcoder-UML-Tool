...
/**
 * <p>
 * This class represents an exception which occurred during parsing in the XMI Reader component. It
 ...
 * @version 1.0
 */
public class XMIReaderParseException extends XMIReaderException {
    /**
     * <p>
     ...
     */
    public XMIReaderParseException(String message) {
     ...
     *         trimmed.
     */
    public XMIReaderParseException(String message, Throwable cause) {

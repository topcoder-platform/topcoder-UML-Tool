...
/**
 * <p>
 * This class represents an input/output exception which occurred in the XMI Reader component. It
 ...
 * @version 1.0
 */
public class XMIReaderIOException extends XMIReaderException {
    /**
     * <p>
     ...
     */
    public XMIReaderIOException(String message) {
     ...
     *         trimmed.
     */
    public XMIReaderIOException(String message, Throwable cause) {

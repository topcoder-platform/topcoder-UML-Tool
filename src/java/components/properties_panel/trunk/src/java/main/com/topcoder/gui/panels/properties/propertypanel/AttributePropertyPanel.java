...
/**
 * <p>
 * This class provides a property panel GUI for the attribute property of <code>ModelElement</code>.
 * </p>
 * <p>
 ...
 * @since 1.0
 */
public class AttributePropertyPanel extends AbstractPropertyPanel {
    /**
     * <p>
     * Creates a new <code>AttributePropertyPanel</code>.
     * </p>
     ...
     */
    public AttributePropertyPanel(PropertiesPanel propertiesPanel) {
        super(Collections.singletonList(PropertyKind.ATTRIBUTE), propertiesPanel);
    ...
    public void execute() {
        if (isConfigured()) {
            ...
            for (ModelElement element : getConfiguredModelElements()) {
                getPropertiesPanel().firePropertyChangeEvent(element, PropertyKind.ATTRIBUTE, PropertyOperation.ADD,
                        null);
            }
        }
    }

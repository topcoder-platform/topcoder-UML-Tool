...
/**
 * Failure tests for StereotypeListPropertyPanel class.
 * 
 * @author Yeung
 * @version 1.0
 */
public class StereotypeListPropertyPanelFailureTests extends TestCase {
    /**
    ...
    /**
     * Tests the constructor StereotypeListPropertyPanel(PropertiesPanel, Icon, Icon) with null propertiesPanel,
    ...
    /**
     * Tests the constructor StereotypeListPropertyPanel(PropertiesPanel, Icon, Icon) with null deleteIcon, expected
    ...
    public void testCtor_NullDeleteIcon() throws Exception {
        try {
            new StereotypeListPropertyPanel(propertiesPanel, new ImageIcon(), null);
            fail("Expect IllegalArgumentException.");
        } catch (IllegalArgumentException iae) {
            // expect
        }
    ...
    public void testCtor_NullAddIcon() throws Exception {
        try {
            new StereotypeListPropertyPanel(propertiesPanel, null, new ImageIcon());
            fail("Expect IllegalArgumentException.");
        } catch (IllegalArgumentException iae) {
            // expect
        }

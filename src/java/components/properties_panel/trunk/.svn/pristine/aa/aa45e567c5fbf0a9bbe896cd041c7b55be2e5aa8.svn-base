...
/**
 * <p>
 * Accuracy Unit test cases for OutgoingTransitionPropertyPanel.
 * </p>
 *
 * @author biotrail
 * @version 1.0
 */
public class OutgoingTransitionPropertyPanelAccuracyTests extends TestCase {
    /**
     * <p>
     * OutgoingTransitionPropertyPanel instance for testing.
     * </p>
     */
    private OutgoingTransitionPropertyPanel instance;
    ...
    protected void setUp() throws Exception {
        ...
        instance = new OutgoingTransitionPropertyPanel(propertiesPanel);
    }
    ...
    public static Test suite() {
        return new TestSuite(OutgoingTransitionPropertyPanelAccuracyTests.class);
    }
    ...
    public void testCtor1() {
        assertNotNull("Failed to create OutgoingTransitionPropertyPanel instance.", instance);
    }

...
/**
 * Failure tests for TypePropertyPanel class.
 *
 * @author Yeung
 * @version 1.0
 */
public class TypePropertyPanelFailureTests extends TestCase {
    /**
    ...
    /**
     * Tests the constructor TypePropertyPanel(PropertiesPanel, Icon) with null propertiesPanel, expected
    ...
    public void testCtor_NullPropertiesPanel() throws Exception {
        try {
            new TypePropertyPanel(null, new ImageIcon());
    ...
    /**
     * Tests the constructor TypePropertyPanel(PropertiesPanel, Icon) with null icon, expected
     * IllegalArgumentException.
     *
     * @throws Exception
     *             if any error occurred when set up

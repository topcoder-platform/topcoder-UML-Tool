...
/**
 * <p>
 * Unit test cases for StylePanel.
 * </p>
 *
 * @author TCSDEVELOPER
 * @version 1.1
 * @since 1.1
 */
public class StylePanelTests extends JFCTestCase {
    /**
     * <p>
    ...
    public static Test suite() {
        return new TestSuite(StylePanelTests.class);
    }
    ...
    public void testCtor1() {
        assertNotNull("Failed to create a new StylePanel instance.", new StylePanel(TestHelper.NAMESPACE));
    }
    ...
    public void testCtor1_PreferredWidthLess() throws Exception {
        ...
        try {
            new StylePanel(TestHelper.NAMESPACE);
            fail("StylePanelConfigurationException expected.");
        } catch (StylePanelConfigurationException e) {
            //good
        }

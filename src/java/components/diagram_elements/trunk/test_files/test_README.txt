...
3. THIS NOTE IS IMPORTANT FOR BUILD AND TEST.
   ...
   1) You can put the main code of "Diagram Viewer" and "Diagram Edges", which are under "src\java\main" into the main of
      "Diagram Elements", then you can compile and test successfully.
   ...
   3) If you can download "diagram_edges.jar" and "diagram_viewer.jar" from catalog directly, then ignore the suggestion above,

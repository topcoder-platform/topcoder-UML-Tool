...
/**
 * <p>
 * Unit test cases for ReturnMessageEdge.
 * </p>
 *
 * @author TCSDEVELOPER
 * @version 1.1
 * @since 1.0
 */
public class ReturnMessageEdgeTests extends TestCase {
    /**
     * <p>
     * ReturnMessageEdge instance for testing.
     * </p>
     */
    private ReturnMessageEdge edge;
    ...
    protected void setUp() {
        ...
        edge = new ReturnMessageEdge(new LinkImpl(), graphEdge, TestHelper.createEdgeEndingProperties(),
    ...
    public static Test suite() {
        return new TestSuite(ReturnMessageEdgeTests.class);
    }

    /**
     * <p>
     * Tests ctor ReturnMessageEdge#ReturnMessageEdge(Link,GraphEdge,EnumMap,EnumMap) for accuracy.
     * </p>
     *
     * <p>
     * It verifies the newly created ReturnMessageEdge instance should not be null.
     * </p>
     */
    public void testCtor() {
        assertNotNull("Failed to create a new ReturnMessageEdge instance.", edge);
    }

    /**
     * <p>
     * Tests ctor ReturnMessageEdge#ReturnMessageEdge(Link,GraphEdge,EnumMap,EnumMap) for failure.
     * </p>
     *
     * <p>
    ...
    public void testCtor_NullLink() {
        try {
            new ReturnMessageEdge(null, graphEdge, TestHelper.createEdgeEndingProperties(),
                TestHelper.createSequenceEdgeProperties());
    ...
    public void testCtor_NullGraphEdge() {
        try {
            new ReturnMessageEdge(new LinkImpl(), null, TestHelper.createEdgeEndingProperties(),
                TestHelper.createSequenceEdgeProperties());
            fail("IllegalArgumentException expected.");
        } catch (IllegalArgumentException iae) {
            //good
    ...
    public void testCtor_NullEndproperty() {
        try {
            new ReturnMessageEdge(new LinkImpl(), graphEdge, null, TestHelper.createSequenceEdgeProperties());
            fail("IllegalArgumentException expected.");
        } catch (IllegalArgumentException iae) {
            //good
        }
    ...
    public void testCtor_EmptyEndproperty() {
        try {
            new ReturnMessageEdge(new LinkImpl(), graphEdge, new EnumMap<ConfiguredEdgeEndingPropertyType, String>(
    ...
    public void testCtor_NullEdgeproperty() {
        try {
            new ReturnMessageEdge(new LinkImpl(), graphEdge, TestHelper.createEdgeEndingProperties(), null);
            fail("IllegalArgumentException expected.");
        } catch (IllegalArgumentException iae) {
            //good
        }
    ...
    public void testCtor_EmptyEdgeproperty() {
        try {
            new ReturnMessageEdge(new LinkImpl(), graphEdge, TestHelper.createEdgeEndingProperties(),
    ...
    /**
     * <p>
     * Tests ReturnMessageEdge#paintComponent(Graphics) for failure.
     * </p>
     *
     * <p>
    ...
    public static void main(String[] args) {
        ...
        // set up the edge instance
        ReturnMessageEdge gEdge = new ReturnMessageEdge(new LinkImpl(), edge, TestHelper.createEdgeEndingProperties(),
            TestHelper.createSequenceEdgeProperties());

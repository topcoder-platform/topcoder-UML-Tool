...
/**
 * This class aggregates accuracy tests for HalfEmptyArrowEdgeEnding class.
 *
 * @author ch_music
 * @version 1.0
 */
public class HalfEmptyArrowEdgeEndingAccuracyTests extends TestCase {

    /**
     * The HalfEmptyArrowEdgeEnding instance.
     */
    private HalfEmptyArrowEdgeEnding test;
    ...
    public void setUp() throws Exception {
        ...
        test = new HalfEmptyArrowEdgeEnding(0, new Point(100, 100), propertyNameMapping);
    }
     ...
     */
    public void testHalfEmptyArrowEdgeEnding1() {
     ...
     * Tests constructor for accuracy.
     */
    public void testHalfEmptyArrowEdgeEnding2() {
        test = new HalfEmptyArrowEdgeEnding(1.0, new Point(), propertyNameMapping);
        assertNotNull("Constructor fails to create instance.", test);
        assertEquals("Fails to retrieve configuration properly.", Color.WHITE, test.getFillColor());
        assertEquals("Fails to retrieve configuration properly.", Color.BLACK, test.getStrokeColor());
        assertEquals("Fails to retrieve configuration properly.", RenderScheme.TopCoderScheme, test
    ...
    public void testPaintComponentGraphics1() throws Exception {
        AccuracyTestImagePrinter printer = new AccuracyTestImagePrinter(
                "test_files/accuracy_tests/half_empty_arrow_edge_ending1.jpg");
    ...
    public void testPaintComponentGraphics2() throws Exception {
        ...
        AccuracyTestImagePrinter printer = new AccuracyTestImagePrinter(
                "test_files/accuracy_tests/half_empty_arrow_edge_ending2.jpg");
        test.paintComponent(printer.initImage());
        printer.print();
    }
    ...
    public void testPaintComponentGraphics3() throws Exception {
        ...
        AccuracyTestImagePrinter printer = new AccuracyTestImagePrinter(
                "test_files/accuracy_tests/half_empty_arrow_edge_ending3.jpg");
        test.paintComponent(printer.initImage());
        printer.print();
    }
}

...
/**
 * <p>
 * The concrete edge ending with half empty arrow used on sequence diagrams.
 ...
 * @since 1.0
 */
public class HalfEmptyArrowEdgeEnding extends ConfiguredEdgeEnding {
    /**
     * <p>
     ...
     */
    public HalfEmptyArrowEdgeEnding(EnumMap<ConfiguredEdgeEndingPropertyType, String> propertyNameMapping) {
     ...
     */
    public HalfEmptyArrowEdgeEnding(double angle, Point endingPoint,
     ...
     * differently for different RenderScheme.
     * </p>
     *

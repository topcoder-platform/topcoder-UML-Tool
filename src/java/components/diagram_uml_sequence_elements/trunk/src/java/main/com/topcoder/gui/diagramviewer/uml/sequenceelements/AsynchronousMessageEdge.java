...
/**
 * <p>
 * The concrete edge for Asynchronous Message used on sequence diagrams.
 ...
 * @since 1.0
 */
public class AsynchronousMessageEdge extends SequenceEdge {
    /**
     * <p>
     ...
     */
    public AsynchronousMessageEdge(Link link, GraphEdge graphEdge,
        EnumMap<ConfiguredEdgeEndingPropertyType, String> endproperty,
        EnumMap<SequenceEdgePropertyType, String> edgeproperty) {
        super(link, graphEdge, new LineStyle(1, 0), new NothingEdgeEnding(endproperty), new EmptyArrowEdgeEnding(

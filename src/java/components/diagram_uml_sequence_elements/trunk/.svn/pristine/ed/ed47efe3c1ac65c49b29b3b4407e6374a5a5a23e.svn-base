...
/**
 * This class aggregates accuracy tests for AsynchronousMessageEdge class.
 *
 * @author ch_music
 * @version 1.0
 */
public class AsynchronousMessageEdgeAccuracyTests extends TestCase {

    /**
     * <p>
     * The AsynchronousMessageEdge instance used for testing.
     * </p>
     */
    private AsynchronousMessageEdge test;
    ...
    protected void setUp() throws Exception {
        ...
        test = new AsynchronousMessageEdge(new LinkImpl(), graphEdge, AccuracyTestHelper.createEdgeEndingProperties(),
     ...
     */
    public void testAsynchronousMessageEdge() {

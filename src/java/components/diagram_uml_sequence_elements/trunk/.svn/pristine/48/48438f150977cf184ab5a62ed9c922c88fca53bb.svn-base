...
/**
 * <p>
 * Unit test cases for SynchronousMessageEdge.
 * </p>
 *
 * @author TCSDEVELOPER
 * @version 1.1
 * @since 1.0
 */
public class SynchronousMessageEdgeTests extends TestCase {
    /**
     * <p>
     * SynchronousMessageEdge instance for testing.
     * </p>
     */
    private SynchronousMessageEdge edge;
    ...
    protected void setUp() {
        ...
        edge = new SynchronousMessageEdge(new LinkImpl(), graphEdge, TestHelper.createEdgeEndingProperties(),
    ...
    public static Test suite() {
        return new TestSuite(SynchronousMessageEdgeTests.class);
    }

    /**
     * <p>
     * Tests ctor SynchronousMessageEdge#SynchronousMessageEdge(Link,GraphEdge,EnumMap,EnumMap) for accuracy.
     * </p>
     *
     * <p>
     * It verifies the newly created SynchronousMessageEdge instance should not be null.
     * </p>
     */
    public void testCtor() {
        assertNotNull("Failed to create a new SynchronousMessageEdge instance.", edge);
    }

    /**
     * <p>
     * Tests ctor SynchronousMessageEdge#SynchronousMessageEdge(Link,GraphEdge,EnumMap,EnumMap) for failure.
     * </p>
     *
     * <p>
    ...
    public void testCtor_NullLink() {
        try {
            new SynchronousMessageEdge(null, graphEdge, TestHelper.createEdgeEndingProperties(),
                TestHelper.createSequenceEdgeProperties());
    ...
    public void testCtor_NullGraphEdge() {
        try {
            new SynchronousMessageEdge(new LinkImpl(), null, TestHelper.createEdgeEndingProperties(),
                TestHelper.createSequenceEdgeProperties());
            fail("IllegalArgumentException expected.");
        } catch (IllegalArgumentException iae) {
            //good
    ...
    public void testCtor_NullEndproperty() {
        try {
            new SynchronousMessageEdge(new LinkImpl(), graphEdge, null, TestHelper.createSequenceEdgeProperties());
            fail("IllegalArgumentException expected.");
        } catch (IllegalArgumentException iae) {
            //good
        }
    ...
    public void testCtor_EmptyEndproperty() {
        try {
            new SynchronousMessageEdge(new LinkImpl(), graphEdge,
    ...
    public void testCtor_NullEdgeproperty() {
        try {
            new SynchronousMessageEdge(new LinkImpl(), graphEdge, TestHelper.createEdgeEndingProperties(), null);
            fail("IllegalArgumentException expected.");
        } catch (IllegalArgumentException iae) {
            //good
        }
     ...
     * </p>
     */
    public void testCtor_EmmptyEdgeproperty() {
        try {
            new SynchronousMessageEdge(new LinkImpl(), graphEdge, TestHelper.createEdgeEndingProperties(),
    ...
    /**
     * <p>
     * Tests SynchronousMessageEdge#paintComponent(Graphics) for failure.
     * </p>
     *
     * <p>
    ...
    public static void main(String[] args) {
        ...
        // set up the edge instance
        SynchronousMessageEdge gEdge = new SynchronousMessageEdge(new LinkImpl(), edge,

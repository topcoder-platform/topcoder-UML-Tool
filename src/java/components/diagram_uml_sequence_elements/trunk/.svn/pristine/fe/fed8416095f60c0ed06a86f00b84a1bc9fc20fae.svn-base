...
/**
 * <p>
 * The concrete edge for Return Message used on sequence diagrams.
 ...
 * @since 1.0
 */
public class ReturnMessageEdge extends SequenceEdge {
    /**
     * <p>
     ...
     *
     * <p>
     * Note, the lineStyle should define dashed line. The left ending should be
     * NothingEdgeEnding. The right ending should be EmptyArrowEdgeEnding.
     * </p>
     *
     ...
     */
    public ReturnMessageEdge(Link link, GraphEdge graphEdge,
        EnumMap<ConfiguredEdgeEndingPropertyType, String> endproperty,
        EnumMap<SequenceEdgePropertyType, String> edgeproperty) {
        super(link, graphEdge, new LineStyle(1, 1), new NothingEdgeEnding(endproperty), new EmptyArrowEdgeEnding(
            endproperty), edgeproperty);
    }

    /**
     * <p>
     * The drawing function for the edge. It paints the edge differently
     * for different RenderScheme.
     * </p>
     *

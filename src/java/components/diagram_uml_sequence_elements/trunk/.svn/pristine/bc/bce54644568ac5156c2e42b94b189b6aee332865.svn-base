...
/**
 * <p>
 * Unit test cases for SendSignalMessageEdge.
 * </p>
 *
 * @author TCSDEVELOPER
 * @version 1.1
 * @since 1.0
 */
public class SendSignalMessageEdgeTests extends TestCase {
    /**
     * <p>
     * SendSignalMessageEdge instance for testing.
     * </p>
     */
    private SendSignalMessageEdge edge;
    ...
    protected void setUp() {
        ...
        edge = new SendSignalMessageEdge(new LinkImpl(), graphEdge, TestHelper.createEdgeEndingProperties(),
    ...
    public static Test suite() {
        return new TestSuite(SendSignalMessageEdgeTests.class);
    }

    /**
     * <p>
     * Tests ctor SendSignalMessageEdge#SendSignalMessageEdge(Link,GraphEdge,EnumMap,EnumMap) for accuracy.
     * </p>
     *
     * <p>
     * It verifies the newly created SendSignalMessageEdge instance should not be null.
     * </p>
     */
    public void testCtor() {
        assertNotNull("Failed to create a new SendSignalMessageEdge instance.", edge);
    }

    /**
     * <p>
     * Tests ctor SendSignalMessageEdge#SendSignalMessageEdge(Link,GraphEdge,EnumMap,EnumMap) for failure.
     * </p>
     *
     * <p>
    ...
    public void testCtor_NullLink() {
        try {
            new SendSignalMessageEdge(null, graphEdge, TestHelper.createEdgeEndingProperties(),
                TestHelper.createSequenceEdgeProperties());
    ...
    public void testCtor_NullGraphEdge() {
        try {
            new SendSignalMessageEdge(new LinkImpl(), null, TestHelper.createEdgeEndingProperties(),
                TestHelper.createSequenceEdgeProperties());
            fail("IllegalArgumentException expected.");
        } catch (IllegalArgumentException iae) {
            //good
    ...
    public void testCtor_NullEndproperty() {
        try {
            new SendSignalMessageEdge(new LinkImpl(), graphEdge, null, TestHelper.createSequenceEdgeProperties());
            fail("IllegalArgumentException expected.");
        } catch (IllegalArgumentException iae) {
            //good
        }
    ...
    public void testCtor_EmptyEndproperty() {
        try {
            new SendSignalMessageEdge(new LinkImpl(), graphEdge, new EnumMap<ConfiguredEdgeEndingPropertyType, String>(
    ...
    public void testCtor_NullEdgeproperty() {
        try {
            new SendSignalMessageEdge(new LinkImpl(), graphEdge, TestHelper.createEdgeEndingProperties(), null);
            fail("IllegalArgumentException expected.");
        } catch (IllegalArgumentException iae) {
            //good
        }
    ...
    public void testCtor_EmptyEdgeproperty() {
        try {
            new SendSignalMessageEdge(new LinkImpl(), graphEdge, TestHelper.createEdgeEndingProperties(),
    ...
    /**
     * <p>
     * Tests SendSignalMessageEdge#paintComponent(Graphics) for failure.
     * </p>
     *
     * <p>
    ...
    public static void main(String[] args) {
        ...
        // set up the edge instance
        SendSignalMessageEdge gEdge = new SendSignalMessageEdge(new LinkImpl(), edge,

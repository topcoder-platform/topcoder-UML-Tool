...
/**
 * <p>
 * A Util class to perform those common operations which are helpful for the test on the new class
 * in v1.1.
 * </p>
 *
 * @author TCSDEVELOPER
...
public class TestUtil {
    ...
    /**
     * <p>This private constructor prevents to create a new instance.</p>
     *
     */
    private TestUtil() {
    ...
    /**
     * <p>
     * Create a invalid <code>EnumMap< LifelinePropertyType, String ></code> instance for tesing
     * use.
     * </p>
     *
     * @return the <code>EnumMap< LifelinePropertyType, String ></code> instance for tesing use.
    ...
    /**
     * <p>
     * Create a valid <code>EnumMap< LifelineSegmentPropertyType, String ></code> instance for
     * tesing use.
     * </p>
     *
     * @return the <code>EnumMap< LifelineSegmentPropertyType, String ></code> instance for tesing
     * use
     */
    ...
    /**
     * <p>
     * Create a invalid <code>EnumMap< LifelineSegmentPropertyType, String ></code> instance for
     * tesing use.
     * </p>
     *
     * @return the <code>EnumMap< LifelineSegmentPropertyType, String ></code> instance for tesing
    ...
    public static ObjectNode[] createObjectNodes(int number) {
        ...
        for (int i = 0; i < number; ++i) {
            ...
            Collection<SelectionCornerType> corners = TestHelper.createSelectionCorner();
            ...
            object.setName("name");
            objNodes[i] = new ObjectNode(object, graphConnector, graphNode, position, bound, corners,
                    propertyNameMapping);
    ...
    public static List<SequenceEdge> createSimpleSequnceEdgeAndAssociation(
        ...
        // work with the first edge,a SynchronousMessageEdge from node 0 to node
        // 1
        ...
        // work with the second edge,a AsynchronousMessageEdge from node 1 to
        // node 2
        ...
        // work with the third edge,a SynchronousMessageEdge from node 1 to node
        // 3
     ...
     *
     * <p>
     * This method is used for testing the layoutStrategy that Sequence edge started from a nd ended
     * at the same ObjectNode.
     * </p>
     *
     * @param edgeNodeMapping the output association between edge and ObjectNode
     *
    ...
    public static List<SequenceEdge> createSequnceEdgeAndAssociationSameObjNodes(
        ...
        // work with the first edge,a AsynchronousMessageEdge from node 0 to
        // node 1
        ...
        // work with the second edge,a AsynchronousMessageEdge from node 0 to
        // node 1
        edge = createAsynchronousMessageEdge();
        nodes = new ObjectNode[2];
        nodes[0] = objNodes[0];
     ...
     * ObjectNodes is not correct.It means for some two successive edges,the ended Node of the
     * former edge is not the same as the started Node of the latter.
     * </p>
     *
     * @param edgeNodeMapping the output association between edge and ObjectNode
     *
    ...
    public static ReturnMessageEdge createReturnMessageEdge() {
        ...
        GraphEdge graphEdge = createGraphEdge();
        return new ReturnMessageEdge(new LinkImpl(), graphEdge, TestHelper.createEdgeEndingProperties(), TestHelper
                .createSequenceEdgeProperties());
    }
    ...
    public static CreateMessageEdge createCreateMessageEdge() {
        ...
        GraphEdge graphEdge = createGraphEdge();
        return new CreateMessageEdge(new LinkImpl(), graphEdge, TestHelper.createEdgeEndingProperties(), TestHelper
                .createSequenceEdgeProperties());
    }
     ...
     * </p>
     *
     * @return the created LifelineSegment
     */
    public static LifelineSegment createLifelineSegment() {

        EnumMap<LifelineSegmentPropertyType, String> property = new EnumMap<LifelineSegmentPropertyType, String>(
                LifelineSegmentPropertyType.class);
        property.put(LifelineSegmentPropertyType.HEIGHT, "height");
        LifelineSegment lS = new LifelineSegment(new GraphNode(), new java.awt.Point(0, 0), new Rectangle(0, 0, 1, 1),
                property);
        return lS;
    }
    ...
    /**
     * <p>
     * Create a Lifeline for testing use.
     * </p>
     *
     ...
     * </p>
     *
     * @return the created DiagramViewer
     */

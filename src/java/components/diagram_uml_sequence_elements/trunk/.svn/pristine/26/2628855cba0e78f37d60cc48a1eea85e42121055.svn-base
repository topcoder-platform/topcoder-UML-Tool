...
/**
 * This class aggregates accuracy tests for CreateMessageEdge class.
 *
 * @author ch_music
 * @version 1.0
 */
public class CreateMessageEdgeAccuracyTests extends TestCase {

    /**
     * <p>
     * The CreateMessageEdge instance used for testing.
     * </p>
     */
    private CreateMessageEdge test;
    ...
    protected void setUp() throws Exception {
        ...
        test = new CreateMessageEdge(new LinkImpl(), graphEdge, AccuracyTestHelper.createEdgeEndingProperties(),
     ...
     */
    public void testCreateMessageEdge() {
    ...
    public void testPaintComponent() throws Exception {
        AccuracyTestImagePrinter printer = new AccuracyTestImagePrinter(
                "test_files/accuracy_tests/create_message_edge.jpg");

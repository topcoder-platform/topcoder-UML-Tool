...
/**
 * <p>
 * This class represents a Class node (with default 'enum' stereotype) in UML diagram. It is an extension of
 ...
 * @version 1.0
 */
public class EnumClassNode extends ClassNode {

    /**
     * <p>
     * Creates an EnumClassNode.
     * </p>
     * @param graphNode
     *            the graphNode representing this EnumClassNode
     * @param properties
     *            the properties name mapping
     */
    public EnumClassNode(GraphNode graphNode, Map<String, String> properties) {

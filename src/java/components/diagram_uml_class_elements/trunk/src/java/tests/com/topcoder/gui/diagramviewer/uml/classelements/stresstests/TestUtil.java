...
public class TestUtil {
    ...
    private static GraphElement createOperationCompartment(Classifier element) {
        ...
        addContained(delimitedSection,
                createOperationGraphElement("operation_2", "float", "parameter_2", "double"));
        element.addFeature(createOperation("operation_3", "String", "parameter_3", "float"));
        addContained(delimitedSection,
                createOperationGraphElement("operation_3", "String", "parameter_3", "float"));

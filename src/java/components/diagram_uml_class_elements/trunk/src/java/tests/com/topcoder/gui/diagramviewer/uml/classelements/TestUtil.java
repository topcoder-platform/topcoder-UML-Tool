...
public class TestUtil {
    ...
    /**
     * <p>
     * This method creates an Abstraction Edge instance.
     * </p>
     * @return an Abstraction Edge instance
     */
    static Edge createAbstractionEdge() {
        GraphEdge root = new GraphEdge();

        // create the Abstraction element
        ModelElement element = new AbstractionImpl();
        setElement(root, element);

        // add two way points
        root.addWaypoint(new com.topcoder.diagraminterchange.Point());
        root.addWaypoint(new com.topcoder.diagraminterchange.Point());

        return new MockedEdge(root);
    }

    /**
     * <p>
     * This method creates a Generalization Edge instance.
     * </p>
     * @return a Generalization Edge instance
     */
    static Edge createGeneralizationEdge() {
        GraphEdge root = new GraphEdge();
    ...
    /**
     * <p>
     * This method creates a Dependency Edge instance.
     * </p>
     * @return a Dependency Edge instance
     */
    static Edge createDependencyEdge() {
        GraphEdge root = new GraphEdge();

...
/**
 * <p>
 * Unit test cases for <code>ClosedArrow</code>.
 * </p>
 *
 * @author littlebull
 * @version 1.0
 */
public class ClosedArrowUnitTests extends TestCase {
    ...
    /**
     * <p>
     * Accuracy test of constructor <code>ClosedArrow()</code>.
    ...
    public static void main(String[] args) {
        ClosedArrow arrow = new ClosedArrow();
        ...
        JFrame frame = new JFrame();
        frame.setTitle("[Demo]ClosedArrow");

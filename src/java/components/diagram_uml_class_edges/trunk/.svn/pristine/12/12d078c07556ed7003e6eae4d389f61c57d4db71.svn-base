...
/**
 * <p>
 * Unit test cases for <code>AbstractionEdge</code>.
 * </p>
 *
 * @author littlebull
 * @version 1.0
 */
public class AbstractionEdgeUnitTests extends TestCase {

    /** <code>AbstractionEdge</code> instance used for testing. */
     ...
     * <p>
     * Failure test of method <code>notifyGraphEdgeChange(String)</code>.
     * With GraphEdge has no Abstraction element.
     * Should throw IllegalGraphElementException.
     * </p>
     *
     * @throws Exception to JUnit
     ...
     * Update the name of Abstraction UML element.
     * </p>
     *
     * @throws Exception to JUnit
     */
     ...
     * <p>
     * Accuracy test of method <code>notifyGraphEdgeChange(String)</code>.
     * Update the stereotype text of Abstraction UML element.
     * </p>
     *
     * @throws Exception to JUnit
     */
    ...
    public static void main(String[] args) throws Exception {
        ...
        AbstractionEdge edge = new AbstractionEdge(UnitTestsHelper.createGraphEdgeForAbstractionEdge());

        // set up the JFrame instance and show it
        JFrame frame = new JFrame();
        frame.setTitle("[Demo]AbstractionEdge");

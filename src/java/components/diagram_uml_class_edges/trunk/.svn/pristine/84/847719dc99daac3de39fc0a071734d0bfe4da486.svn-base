...
/**
 * <p>
 * Unit test cases for <code>AggregationBiDirectional</code>.
 * </p>
 *
 * @author littlebull
 * @version 1.0
 */
public class AggregationBiDirectionalUnitTests extends TestCase {
    ...
    public void testCtor_Failure_NullName() {
        try {
            new AggregationBiDirectional(null, multiplicity);
    ...
    public void testCtor_Failure_NullMultiplicity() {
        try {
            new AggregationBiDirectional(name, null);
            fail("Should throw IAE.");
        } catch (IllegalArgumentException e) {
            //pass
        }
    ...
    public static void main(String[] args) {
        // create the AggregationBiDirectional instance
        AggregationBiDirectional edgeEnding = UnitTestsHelper.createAggregationBiDirectional();
        edgeEnding.setBorder(new LineBorder(Color.red));

        // set up the JFrame instance and show it
        JFrame frame = new JFrame();
        frame.setTitle("[Demo]AggregationBiDirectional");

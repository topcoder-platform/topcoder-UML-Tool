 ...
 *
 * <p>
 * It can draw a filled (with the color of parent edge) diamond (with a simple arrow) at specified location and angle,
 * and it also can determine whether given point is in the edge ending diamond and arrow triangle. It also allows
 * selection, name/multiplicity and edge ending popup menu, because it is a child of the ActiveEdgeEnding.
 * </p>
 *
 * <p>
 ...
 * @version 1.0
 */
public class CompositionBiDirectional extends ActiveEdgeEnding {
    ...
    /**
     * <p>
     * Construct the <code>CompositionBiDirectional</code> active edge ending with specified name and multiplicity
     * compartments.
     * </p>
     *
     * @param name
     ...
     */
    public CompositionBiDirectional(TextField name, TextField multiplicity) {
        super(name, multiplicity);
    }

    /**
     * <p>
     * Paint the filled (with the color of parent edge) diamond (with a simple arrow): &gt;&lt;*&gt;.
     * </p>
     *
     * @param g

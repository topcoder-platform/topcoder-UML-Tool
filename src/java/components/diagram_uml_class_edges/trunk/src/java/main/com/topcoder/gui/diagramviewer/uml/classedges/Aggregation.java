 ...
 *
 * <p>
 * It can draw an empty (white) diamond at specified location and angle, and it also can determine whether given point
 * is in the edge ending diamond. It also allows selection, name/multiplicity and edge ending popup menu, because it is
 * a child of the {@link ActiveEdgeEnding}.
 * </p>
 *
 * <p>
 ...
 * @version 1.0
 */
public class Aggregation extends ActiveEdgeEnding {
    ...
    /**
     * <p>
     * Construct the <code>Aggregation</code> active edge ending with specified name and multiplicity compartments.
     * </p>
     *
     * @param name
     ...
     */
    public Aggregation(TextField name, TextField multiplicity) {
        super(name, multiplicity);
    }

    /**
     * <p>
     * Paint the empty (white) diamond: &lt;&gt;.
     * </p>
     *
     * @param g
...
//        g2.rotate(-getAngle(), endingPoint.getX(), endingPoint.getY());
        ...
        diamond.addPoint(endingPoint.x - ARROW_LENGTH, endingPoint.y + ARROW_LENGTH);
        diamond.addPoint(endingPoint.x - 2 * ARROW_LENGTH, endingPoint.y);

...
/**
 * <p>
 * Unit test cases for <code>GeneralizationEdge</code>.
 * </p>
 *
 * @author littlebull
 * @version 1.0
 */
public class GeneralizationEdgeUnitTests extends TestCase {
    ...
    protected void setUp() throws Exception {
        graphEdge = UnitTestsHelper.createGraphEdgeForGeneralizationEdge();
     ...
     * <p>
     * Failure test of method <code>notifyGraphEdgeChange(String)</code>.
     * With GraphEdge has no Generalization element.
     * Should throw IllegalGraphElementException.
     * </p>
     *
     * @throws Exception to JUnit
    ...
    public static void main(String[] args) throws Exception {
        ...
        GeneralizationEdge edge = new GeneralizationEdge(UnitTestsHelper.createGraphEdgeForGeneralizationEdge());

        // set up the JFrame instance and show it
        JFrame frame = new JFrame();
        frame.setTitle("[Demo]GeneralizationEdge");

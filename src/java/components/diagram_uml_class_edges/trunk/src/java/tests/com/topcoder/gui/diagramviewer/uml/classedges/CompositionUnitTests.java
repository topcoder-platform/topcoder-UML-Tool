...
/**
 * <p>
 * Unit test cases for <code>Composition</code>.
 * </p>
 *
 * @author littlebull
 * @version 1.0
 */
public class CompositionUnitTests extends TestCase {
    ...
    public void testCtor_Failure_NullName() {
        try {
            new Composition(null, multiplicity);
    ...
    public static void main(String[] args) {
        ...
        Composition edgeEnding = UnitTestsHelper.createComposition();
        edgeEnding.setBorder(new LineBorder(Color.red));

        // set up the JFrame instance and show it
        JFrame frame = new JFrame();
        frame.setTitle("[Demo]Composition");

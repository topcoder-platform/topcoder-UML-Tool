...
/**
 * <p>
 * Mock class extend from class <code>ClosableTabbedPane</code> for stress
 * tests.
 * </p>
 *
 * @author Littleken
 * @version 1.0
 */
public class MockClosableTabbedPaneForStress extends ClosableTabbedPane {

    /**
     * <p>
     * Default constructor for class <code>MockClosableTabbedPaneForStress</code>.
     * </p>
     */
    public MockClosableTabbedPaneForStress() {
     ...
     */
    public boolean[] fireTabsClosingEvent(ClosableTabbedPaneEvent[] events) {
     ...
     *              The event to fire. Must not be null/empty or contain nulls.
     */
    public void fireTabsClosedEvent(ClosableTabbedPaneEvent[] events) {

...
/**
 * <p>
 * Test class: <code>DefaultSideMenuModel</code>.
 * </p>
 *
 * @author KingStone
 * @version 1.0
...
public class DefaultSideMenuModelTest extends TestCase {
     ...
     * @param expanded if expanded
     * @param floating if floating
     * @param absoluteWidth the absolute width
     */
     ...
     *             to JUnit
     */
    public void testMethodAddPropertyChangeListener_PropertyChangeListener() throws Exception {

...
public class TestHelper {
     ...
     * </p>
     */
    public static final String NAMESPACE_NEW = "com.topcoder.gui.trees.document.impl_new";
    ...
    public static void loadConfigurations() throws Exception {
        ...
        TestHelper.loadXMLConfig("test_files" + File.separator + "invalid_config.xml");

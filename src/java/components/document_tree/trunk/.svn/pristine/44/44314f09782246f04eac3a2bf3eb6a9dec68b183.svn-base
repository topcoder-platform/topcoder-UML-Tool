...
import com.topcoder.gui.trees.document.impl.PackageCentricDocumentTreeView;
...
/**
 * Accuracy test for <code>PackageCentricDocumentTreeView</code>.
 * 
 * @author enefem21
 * @version 1.0
 */
public class PackageCentricDocumentTreeViewTest extends TestCase {
    ...
    /** Unit under test. */
    private PackageCentricDocumentTreeView treeView;
    ...
    public static Test suite() {
        return new TestSuite(PackageCentricDocumentTreeViewTest.class);
    }
    ...
    protected void setUp() throws Exception {
        ...
        treeView =
            new PackageCentricDocumentTreeView(documentTreePanelImpl,
                "com.topcoder.gui.trees.document.impl.DocumentTreeTabbedPaneImpl");
    }
     ...
     *             to JUnit
     */
    public void testPackageCentricDocumentTreeView() throws Exception {
        PackageCentricDocumentTreeView treeView =
            new PackageCentricDocumentTreeView(documentTreePanelImpl,
                "com.topcoder.gui.trees.document.impl.DocumentTreeTabbedPaneImpl");
        ...
        assertEquals("The field is not set as expected", DocumentTreeViewType.PACKAGE_CENTRIC, viewTypeField
            .get(treeView));
    }

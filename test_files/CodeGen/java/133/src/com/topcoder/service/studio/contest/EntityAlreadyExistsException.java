...
/**
 * This exception extends the ContestManagementException, and it is thrown when the entity already exists the persistence, but it's not supposed to be.
*/
 ...
 * and a <code>cause</code>, as well as the additional <code>data</code>to attach to the critical exception. Simply call super(message, cause, data). </p>
 * 
 * #Param
 * message - the error message.
 * cause - the inner exception.

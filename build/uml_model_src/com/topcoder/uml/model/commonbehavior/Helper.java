...
public class Helper {
    ...
    /**
     * <p>
     * Validates the value of a variable with type <code>int</code>.
     * The value cannot be out of the range of [0, max].
     * </p>
     *
     * @param value value of the variable.
     * @param max maximum value allowed.
     * @param rangeDescription description of the range.
     *
     * @throws IndexOutOfBoundsException if <code>value</code> is out of range.
     */
    public static void validateIndexRange(int value, int max, String rangeDescription) {
        if ((value < 0) || (value > max)) {
            throw new IndexOutOfBoundsException("index should be in range of " + rangeDescription);
        }
    }
